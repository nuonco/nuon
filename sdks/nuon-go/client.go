...
type Client interface {
	...
	CreateRole(ctx context.Context, req *models.ServiceCreateRoleRequest) (*models.AppRole, error)
	GetRole(ctx context.Context, roleID string) (*models.AppRole, error)
	UpdateRole(ctx context.Context, roleID string, req *models.ServiceUpdateRoleRequest) (*models.AppRole, error)
	...
	GetTriggerEvent(ctx context.Context, id string) (*models.TriggerEvent, error)
	GetTriggerEventRaw(ctx context.Context, id string) (*models.TriggerEventRaw, error)
	ReplayTriggerEvent(ctx context.Context, id string) (*models.TriggerEventReplayResponse, error)
	ListTriggerEventDispatches(ctx context.Context, limit int) ([]*models.TriggerEventDispatch, error)
	ListTriggerEventDispatchesPage(ctx context.Context, limit int, eventID, cursor string) (*models.TriggerEventDispatchPage, error)
	GetTriggerEventDispatch(ctx context.Context, id string) (*models.TriggerEventDispatch, error)
	RetryTriggerEventDispatch(ctx context.Context, id string) (*models.TriggerEventDispatchRetryResponse, error)
	CreateTrigger(ctx context.Context, req *models.TriggerCreateRequest) (*models.TriggerCredentialResponse, error)
	ListTriggers(ctx context.Context) ([]*models.Trigger, error)
	GetTrigger(ctx context.Context, id string) (*models.Trigger, error)
	RotateTriggerSecret(ctx context.Context, id string) (*models.TriggerCredentialResponse, error)
	EnableTrigger(ctx context.Context, id string) (*models.Trigger, error)
	DisableTrigger(ctx context.Context, id string) (*models.Trigger, error)
	RevokeTriggerSecret(ctx context.Context, triggerID, secretID string) (*models.TriggerRevokeResponse, error)
	RevealTriggerSecret(ctx context.Context, triggerID, secretID string) (*models.TriggerSecretRevealResponse, error)
	GetTriggerIngressURL(ctx context.Context, id string) (*models.TriggerIngressURLResponse, error)
