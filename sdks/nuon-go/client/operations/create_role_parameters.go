...
type CreateRoleParams struct {
	...
	/* Req.
	   ...
	   Input
	*/
	Req *models.ServiceCreateRoleRequest
...
// WithReq adds the req to the create role params
func (o *CreateRoleParams) WithReq(req *models.ServiceCreateRoleRequest) *CreateRoleParams {
	o.SetReq(req)
	return o
}

// SetReq adds the req to the create role params
func (o *CreateRoleParams) SetReq(req *models.ServiceCreateRoleRequest) {
	o.Req = req
}
