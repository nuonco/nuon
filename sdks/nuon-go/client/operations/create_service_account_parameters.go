...
type CreateServiceAccountParams struct {
	...
	/* Req.
	   ...
	   Input
	*/
	Req *models.ServiceCreateServiceAccountRequest
...
// WithReq adds the req to the create service account params
func (o *CreateServiceAccountParams) WithReq(req *models.ServiceCreateServiceAccountRequest) *CreateServiceAccountParams {
	o.SetReq(req)
	return o
}

// SetReq adds the req to the create service account params
func (o *CreateServiceAccountParams) SetReq(req *models.ServiceCreateServiceAccountRequest) {
	o.Req = req
}
