...
// WithAccountID adds the accountID to the delete service account params
func (o *DeleteServiceAccountParams) WithAccountID(accountID string) *DeleteServiceAccountParams {
	o.SetAccountID(accountID)
	return o
}

// SetAccountID adds the accountId to the delete service account params
func (o *DeleteServiceAccountParams) SetAccountID(accountID string) {
