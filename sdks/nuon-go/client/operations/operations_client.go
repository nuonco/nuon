...
type ClientService interface {
	...
	UpdateEnvAccentConfig(params *UpdateEnvAccentConfigParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UpdateEnvAccentConfigOK, error)
...
/*
UpdateEnvAccentConfig updates env accent config

Replaces the env accent config used to paint install indicators in the dashboard.
*/
func (a *Client) UpdateEnvAccentConfig(params *UpdateEnvAccentConfigParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UpdateEnvAccentConfigOK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewUpdateEnvAccentConfigParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "UpdateEnvAccentConfig",
		Method:             "PUT",
		PathPattern:        "/v1/orgs/current/env-accent-config",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &UpdateEnvAccentConfigReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	// only one success response has to be checked
	success, ok := result.(*UpdateEnvAccentConfigOK)
	if ok {
		return success, nil
	}
	...
	//
	// safeguard: normally, in the absence of a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for UpdateEnvAccentConfig: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
