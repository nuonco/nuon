...
type CreateServiceAccountTokenParams struct {
	...
	*/
	...
	/* Req.
	   ...
	   Input
	*/
	Req *models.ServiceCreateServiceAccountTokenRequest
...
// WithAccountID adds the accountID to the create service account token params
func (o *CreateServiceAccountTokenParams) WithAccountID(accountID string) *CreateServiceAccountTokenParams {
	o.SetAccountID(accountID)
	return o
}

// SetAccountID adds the accountId to the create service account token params
func (o *CreateServiceAccountTokenParams) SetAccountID(accountID string) {
	o.AccountID = accountID
}

// WithReq adds the req to the create service account token params
func (o *CreateServiceAccountTokenParams) WithReq(req *models.ServiceCreateServiceAccountTokenRequest) *CreateServiceAccountTokenParams {
	o.SetReq(req)
	return o
}

// SetReq adds the req to the create service account token params
func (o *CreateServiceAccountTokenParams) SetReq(req *models.ServiceCreateServiceAccountTokenRequest) {
	o.Req = req
}
