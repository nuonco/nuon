...
// WithReq adds the req to the update role params
func (o *UpdateRoleParams) WithReq(req *models.ServiceUpdateRoleRequest) *UpdateRoleParams {
	o.SetReq(req)
	return o
}

// SetReq adds the req to the update role params
func (o *UpdateRoleParams) SetReq(req *models.ServiceUpdateRoleRequest) {
	o.Req = req
}
