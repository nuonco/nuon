...
func (o *DeleteRoleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /v1/roles/{role_id}] DeleteRole", response, response.Code())
	}
}
...
func (o *DeleteRoleNoContent) Error() string {
	return fmt.Sprintf("[DELETE /v1/roles/{role_id}][%d] deleteRoleNoContent", 204)
}
...
func (o *DeleteRoleBadRequest) Error() string {
	...
	return fmt.Sprintf("[DELETE /v1/roles/{role_id}][%d] deleteRoleBadRequest %s", 400, payload)
}
...
func (o *DeleteRoleBadRequest) GetPayload() *models.StderrErrResponse {
	return o.Payload
}
...
func (o *DeleteRoleUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /v1/roles/{role_id}][%d] deleteRoleUnauthorized %s", 401, payload)
}
...
func (o *DeleteRoleUnauthorized) GetPayload() *models.StderrErrResponse {
	return o.Payload
}
...
func (o *DeleteRoleForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /v1/roles/{role_id}][%d] deleteRoleForbidden %s", 403, payload)
}
...
func (o *DeleteRoleForbidden) GetPayload() *models.StderrErrResponse {
	return o.Payload
}
...
func (o *DeleteRoleNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /v1/roles/{role_id}][%d] deleteRoleNotFound %s", 404, payload)
}
...
func (o *DeleteRoleNotFound) GetPayload() *models.StderrErrResponse {
	return o.Payload
}
...
func (o *DeleteRoleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /v1/roles/{role_id}][%d] deleteRoleInternalServerError %s", 500, payload)
}
...
func (o *DeleteRoleInternalServerError) GetPayload() *models.StderrErrResponse {
	return o.Payload
}
