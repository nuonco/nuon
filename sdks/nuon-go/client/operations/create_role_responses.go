...
func (o *CreateRoleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /v1/roles] CreateRole", response, response.Code())
	}
}
...
func (o *CreateRoleCreated) Error() string {
	...
	return fmt.Sprintf("[POST /v1/roles][%d] createRoleCreated %s", 201, payload)
}
...
func (o *CreateRoleCreated) GetPayload() *models.AppRole {
	return o.Payload
}
...
func (o *CreateRoleBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/roles][%d] createRoleBadRequest %s", 400, payload)
}
...
func (o *CreateRoleBadRequest) GetPayload() *models.StderrErrResponse {
	return o.Payload
}
...
func (o *CreateRoleUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/roles][%d] createRoleUnauthorized %s", 401, payload)
}
...
func (o *CreateRoleUnauthorized) GetPayload() *models.StderrErrResponse {
	return o.Payload
}
...
func (o *CreateRoleForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/roles][%d] createRoleForbidden %s", 403, payload)
}
...
func (o *CreateRoleForbidden) GetPayload() *models.StderrErrResponse {
	return o.Payload
}
...
func (o *CreateRoleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/roles][%d] createRoleInternalServerError %s", 500, payload)
}
...
func (o *CreateRoleInternalServerError) GetPayload() *models.StderrErrResponse {
	return o.Payload
}
