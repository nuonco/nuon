...
func (o *UpdateServiceAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PATCH /v1/service-accounts/{account_id}] UpdateServiceAccount", response, response.Code())
	}
}
...
func (o *UpdateServiceAccountOK) Error() string {
	...
	return fmt.Sprintf("[PATCH /v1/service-accounts/{account_id}][%d] updateServiceAccountOK %s", 200, payload)
}
...
func (o *UpdateServiceAccountOK) GetPayload() *models.AppAccount {
	return o.Payload
}
...
func (o *UpdateServiceAccountBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /v1/service-accounts/{account_id}][%d] updateServiceAccountBadRequest %s", 400, payload)
}
...
func (o *UpdateServiceAccountBadRequest) GetPayload() *models.StderrErrResponse {
	return o.Payload
}
...
func (o *UpdateServiceAccountUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /v1/service-accounts/{account_id}][%d] updateServiceAccountUnauthorized %s", 401, payload)
}
...
func (o *UpdateServiceAccountUnauthorized) GetPayload() *models.StderrErrResponse {
	return o.Payload
}
...
func (o *UpdateServiceAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /v1/service-accounts/{account_id}][%d] updateServiceAccountForbidden %s", 403, payload)
}
...
func (o *UpdateServiceAccountForbidden) GetPayload() *models.StderrErrResponse {
	return o.Payload
}
...
func (o *UpdateServiceAccountNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /v1/service-accounts/{account_id}][%d] updateServiceAccountNotFound %s", 404, payload)
}
...
func (o *UpdateServiceAccountNotFound) GetPayload() *models.StderrErrResponse {
	return o.Payload
}
...
func (o *UpdateServiceAccountInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /v1/service-accounts/{account_id}][%d] updateServiceAccountInternalServerError %s", 500, payload)
}
...
func (o *UpdateServiceAccountInternalServerError) GetPayload() *models.StderrErrResponse {
	return o.Payload
}
