...
const (
	...
	// ConfigInstallApprovalOptionAuto captures enum value "auto"
	ConfigInstallApprovalOptionAuto ConfigInstallApprovalOption = "auto"
...
// for schema
var configInstallApprovalOptionEnum []any

func init() {
	var res []ConfigInstallApprovalOption
	if err := json.Unmarshal([]byte(`["approve-all","auto","prompt",""]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
