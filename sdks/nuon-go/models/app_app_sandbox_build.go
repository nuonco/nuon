...
func (m *AppAppSandboxBuild) validateCompositeError(formats strfmt.Registry) error {
...
func (m *AppAppSandboxBuild) contextValidateCompositeError(ctx context.Context, formats strfmt.Registry) error {
