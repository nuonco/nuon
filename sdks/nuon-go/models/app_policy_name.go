...
const (
	...
	// AppPolicyNameCustom captures enum value "custom"
	AppPolicyNameCustom AppPolicyName = "custom"
)
...
func init() {
	...
	if err := json.Unmarshal([]byte(`["org_admin","org_support","org_read_only","org_builder","installer","runner","hosted_installer","custom"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
