...
//
// swagger:model config.EnvironmentVariable
...
// ContextValidate validates this config environment variable based on context it is used
func (m *ConfigEnvironmentVariable) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
