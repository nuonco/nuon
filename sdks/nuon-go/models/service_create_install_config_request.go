...
func (m *ServiceCreateInstallConfigRequest) validateTelemetry(formats strfmt.Registry) error {
...
func (m *ServiceCreateInstallConfigRequest) contextValidateTelemetry(ctx context.Context, formats strfmt.Registry) error {
