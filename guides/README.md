...
This directory is where we create and maintain guides for doing different development tasks.

## Table of contents

### style guides

- [testing in go](./go_testing.md)
- [go best practices WIP](./go_best_practices.md)
