...
func (m *Plan) validate(all bool) error {
	...
	case *Plan_WaypointPlan:
		...
		if all {
			switch v := interface{}(m.GetWaypointPlan()).(type) {
		...
		} else if v, ok := interface{}(m.GetWaypointPlan()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
	...
	case *Plan_TerraformPlan:
		...
		if all {
			switch v := interface{}(m.GetTerraformPlan()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, PlanValidationError{
						field:  "TerraformPlan",
		...
		} else if v, ok := interface{}(m.GetTerraformPlan()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return PlanValidationError{
					field:  "TerraformPlan",
					reason: "embedded message failed validation",
	...
	case *Plan_RunnerPlan:
		...
		if all {
			switch v := interface{}(m.GetRunnerPlan()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, PlanValidationError{
						field:  "RunnerPlan",
		...
		} else if v, ok := interface{}(m.GetRunnerPlan()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return PlanValidationError{
					field:  "RunnerPlan",
					reason: "embedded message failed validation",
