...
func (m *AccountSettings) validate(all bool) error {
	...
	if _, ok := _AccountSettings_Region_InLookup[m.GetRegion()]; !ok {
		err := AccountSettingsValidationError{
			field:  "Region",
	...
	if utf8.RuneCountInString(m.GetAwsAccountId()) < 12 {
		err := AccountSettingsValidationError{
			field:  "AwsAccountId",
	...
	if utf8.RuneCountInString(m.GetAwsRoleArn()) < 20 {
		err := AccountSettingsValidationError{
			field:  "AwsRoleArn",
...
var _AccountSettings_Region_InLookup = map[string]struct{}{
	"us-west-2": {},
	"us-west-1": {},
	"us-east-2": {},
	"us-east-1": {},
