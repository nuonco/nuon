...
// @Description.markdown	install_action_workflow_runs_get.md
...
// @Router					/v1/installs/{install_id}/actions/runs [get]
func (s *service) GetInstallActionRuns(ctx *gin.Context) {
