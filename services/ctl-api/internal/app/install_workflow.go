...
type InstallWorkflow struct {
	...
	Type              InstallWorkflowType `json:"type,omitzero" gorm:"not null;default null" temporaljson:"type,omitzero,omitempty"`
	...
	Steps []InstallWorkflowStep `json:"steps,omitzero" gorm:"constraint:OnDelete:CASCADE;" temporaljson:"steps,omitzero,omitempty"`
