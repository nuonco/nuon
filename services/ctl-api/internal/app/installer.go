...
type Installer struct {
	...
	OrgID string `json:"org_id" gorm:"notnull" temporaljson:"org_id,omitzero,omitempty"`
	Org   Org    `faker:"-" json:"-" temporaljson:"org,omitzero,omitempty"`

	Apps []App `json:"apps" gorm:"many2many:installer_apps;constraint:OnDelete:CASCADE;" temporaljson:"apps,omitzero,omitempty"`

	Type     InstallerType     `json:"type" temporaljson:"type,omitzero,omitempty"`
	Metadata InstallerMetadata `json:"metadata" gorm:"constraint:OnDelete:CASCADE;" temporaljson:"metadata,omitzero,omitempty"`
}
