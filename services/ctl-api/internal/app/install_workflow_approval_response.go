...
type InstallWorkflowApprovalResponse struct {
	...
	InstallWorkflowApprovalID string `json:"install_workflow_approval_id,omitzero" gorm:"notnull;default null" temporaljson:"install_workflow_approval_id,omitzero,omitempty"`
}
