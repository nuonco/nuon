...
type ComponentReleaseStep struct {
	...
	// parent release ID
	ComponentReleaseID string           `json:"component_release_id" temporaljson:"component_release_id,omitzero,omitempty"`
	ComponentRelease   ComponentRelease `json:"-" temporaljson:"component_release,omitzero,omitempty"`

	Status            string `json:"status" temporaljson:"status,omitzero,omitempty"`
	...
	RequestedInstallIDs pq.StringArray  `json:"requested_install_ids" swaggertype:"array,string" gorm:"type:text[]" temporaljson:"requested_install_i_ds,omitzero,omitempty"`
	InstallDeploys      []InstallDeploy `json:"install_deploys,omitempty" gorm:"constraint:OnDelete:CASCADE;" temporaljson:"install_deploys,omitzero,omitempty"`

	// fields to control the delay of the individual step, as this is set based on the parent strategy
	Delay *string `json:"delay" temporaljson:"delay,omitzero,omitempty"`
}
