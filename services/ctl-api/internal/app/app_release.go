...
import (
	...
	"github.com/nuonco/nuon/pkg/releases"
...
type AppRelease struct {
	...
	Runbooks          []releases.RunbookTemplate `json:"-" gorm:"type:jsonb;serializer:json;<-:create"`
	...
	SourceFiles []releases.ReleaseFile `json:"source_files,omitempty" gorm:"-"`
}
