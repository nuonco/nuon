...
type OtelMetricGauge struct {
	...
	ScopeDroppedAttrCount int               `json:"scope_dropped_attr_count,omitzero" gorm:"type:UInt32;codec:ZSTD(1)" temporaljson:"scope_dropped_attr_count,omitzero,omitempty"`
	...
	Exemplars []OtelMetricGaugeExemplar `json:"-" gorm:"type:Nested(filtered_attributes Map(LowCardinality(String), String), time_unix DateTime64(9), value Float64, span_id String, trace_id String); codec:ZSTD(1);" temporaljson:"exemplars,omitzero,omitempty"`
}
