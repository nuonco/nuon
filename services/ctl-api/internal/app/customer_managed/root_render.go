...
func renderConfigForStackCompile(cfg *app.AppConfig, installID string, inputs []customermanaged.InputSpec) (*app.AppConfig, error) {
	...
	st := &statepkg.State{
		...
		Install: &statepkg.InstallState{ID: installID, Name: "customer_managed", Populated: true, Inputs: inputValues},
