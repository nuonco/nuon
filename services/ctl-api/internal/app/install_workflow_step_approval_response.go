...
type InstallWorkflowStepApprovalResponse struct {
	...
	InstallWorkflowStepApprovalID string `temporaljson:"install_workflow_step_approval_id,omitzero,omitempty"`

	// the response type
	Type InstallWorkflowStepResponseType `temporaljson:"type,omitzero,omitempty"`
}
