...
- [ ] Add a model to allow for the creation of additional identity providers.
- [ ] Enforce uniqueness constraint: one provider of each type per install _including_ the default.\*

Split up the service configs into discrete sets.
...
Split up the service fx providers into discrete sets.
