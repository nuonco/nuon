...
// @Description			Ancestor-scoped alternative to the bare route: authorizes against the install that owns the workflow, so an identity scoped to that install can reach it.
...
// @Router					/v1/installs/{install_id}/workflows/{workflow_id} [get]
func (s *service) GetWorkflowByInstall(ctx *gin.Context) {
	s.GetWorkflow(ctx)
}
...
// @Failure					500	{object}	stderr.ErrResponse
// @Success					200	{object}	app.Workflow
// @Router					/v1/installs/{install_id}/workflows/{workflow_id} [PATCH]
func (s *service) UpdateWorkflowByInstall(ctx *gin.Context) {
...
// @Router					/v1/installs/{install_id}/workflows/{workflow_id}/cancel [POST]
func (s *service) CancelWorkflowByInstall(ctx *gin.Context) {
...
// @Router					/v1/installs/{install_id}/workflows/{workflow_id}/queue-position [get]
func (s *service) GetWorkflowQueuePositionByInstall(ctx *gin.Context) {
...
// @Router					/v1/installs/{install_id}/workflows/{workflow_id}/step-groups [get]
func (s *service) GetWorkflowStepGroupsByInstall(ctx *gin.Context) {
...
// @Router					/v1/installs/{install_id}/workflows/{workflow_id}/step-groups/{{step_group_id}} [get]
func (s *service) GetWorkflowStepGroupByInstall(ctx *gin.Context) {
...
// @Router					/v1/installs/{install_id}/workflows/{workflow_id}/steps [get]
func (s *service) GetWorkflowStepsByInstall(ctx *gin.Context) {
...
// @Router					/v1/installs/{install_id}/workflows/{workflow_id}/steps/{{step_id}} [get]
func (s *service) GetWorkflowStepByInstall(ctx *gin.Context) {
...
// @Failure					500	{object}	stderr.ErrResponse
// @Success					200	{object}	app.WorkflowStep
// @Router					/v1/installs/{install_id}/workflows/{workflow_id}/steps/{{step_id}}/await [get]
func (s *service) AwaitWorkflowStepByInstall(ctx *gin.Context) {
...
// @Router					/v1/installs/{install_id}/workflows/{workflow_id}/steps/{{step_id}}/retry [POST]
func (s *service) RetryWorkflowStepByInstall(ctx *gin.Context) {
...
// @Router					/v1/installs/{install_id}/workflows/{workflow_id}/steps/{{step_id}}/skip [POST]
func (s *service) SkipWorkflowStepByInstall(ctx *gin.Context) {
...
// @Router					/v1/installs/{install_id}/workflows/{workflow_id}/steps/{{step_id}}/cancel [POST]
func (s *service) CancelWorkflowStepByInstall(ctx *gin.Context) {
...
// @Router					/v1/installs/{install_id}/workflows/{workflow_id}/steps/{{step_id}}/approvals/{{approval_id}} [get]
func (s *service) GetWorkflowStepApprovalByInstall(ctx *gin.Context) {
...
// @Router					/v1/installs/{install_id}/workflows/{workflow_id}/steps/{{step_id}}/approvals/{{approval_id}}/response [POST]
func (s *service) CreateWorkflowStepApprovalResponseByInstall(ctx *gin.Context) {
...
// @Router					/v1/installs/{install_id}/workflows/{workflow_id}/steps/{{step_id}}/approvals/{{approval_id}}/contents [get]
func (s *service) GetWorkflowStepApprovalContentsByInstall(ctx *gin.Context) {
