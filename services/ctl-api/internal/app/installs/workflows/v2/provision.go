...
func Provision(ctx workflow.Context, flw *app.Workflow) (*app.GenerateStepsResult, error) {
	...
	sg.nextGroupLabeled(StepGroupGenerateInstallState())
	...
	sg.nextGroupLabeled(StepGroupProvisionRunnerServiceAccount())
	...
	sg.nextGroupLabeled(StepGroupProvisionInstallStack())
	...
	sg.nextGroupLabeled(StepGroupProvisionSandbox())
	...
	if !flw.PlanOnly {
		...
		sg.nextGroupLabeled(StepGroupSyncSecrets())
		...
		sg.nextGroupLabeled(StepGroupProvisionSandboxDNS())
