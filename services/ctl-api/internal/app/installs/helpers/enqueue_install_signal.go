...
func (h *Helpers) enqueueInstallSignal(ctx context.Context, installID, queueName string, sig queuesignal.Signal, ownerID, ownerType string, cb callback.Ref) error {
	var q app.Queue
