...
type AppSecret struct {
	...
	AppID string `json:"app_id" gorm:"not null;default null;index:idx_app_secret_name,unique" temporaljson:"app_id,omitzero,omitempty"`
	App   App    `json:"-" faker:"-" temporaljson:"app,omitzero,omitempty"`

	Name  string `json:"name" gorm:"not null;default null;index:idx_app_secret_name,unique" temporaljson:"name,omitzero,omitempty"`
	Value string `json:"-" gorm:"not null;default null" temporaljson:"value,omitzero,omitempty"`

	// after query fields
	Length int `json:"length" gorm:"-" temporaljson:"length,omitzero,omitempty"`
}
