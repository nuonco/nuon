...
type InstallActionWorkflowManualTrigger struct {
	...
	InstallActionWorkflowRun InstallActionWorkflowRun `json:"install_action_workflow_run" gorm:"polymorphic:TriggeredBy;" temporaljson:"install_action_workflow_run,omitzero,omitempty"`
}
