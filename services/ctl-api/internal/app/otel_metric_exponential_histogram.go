...
type OtelMetricExponentialHistogram struct {
	...
	PositiveBucketCounts []uint64 `json:"positive_bucket_counts,omitzero" gorm:"type:Array(UInt64); codec:ZSTD(1)" temporaljson:"positive_bucket_counts,omitzero,omitempty"`
	...
	NegativeBucketCounts []uint64 `json:"negative_bucket_counts,omitzero" gorm:"type:Array(UInt64); codec:ZSTD(1)" temporaljson:"negative_bucket_counts,omitzero,omitempty"`
...
func (m OtelMetricExponentialHistogram) GetTableOptions() string {
	return `ENGINE = ReplicatedMergeTree('/var/lib/clickhouse/{cluster}/tables/{shard}/{uuid}/otel_metrics_exponential_histogram', '{replica}')
...
func (m OtelMetricExponentialHistogram) GetTableClusterOptions() string {
