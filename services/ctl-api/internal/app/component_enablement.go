...
// source of truth for a component's toggle.
...
func (r *ComponentEnablementResolver) OwnEnabled(compID string) bool {
	return ComponentEnabledFromInputs(r.enabledInputs, r.cccByID[compID])
}
...
func (r *ComponentEnablementResolver) DirectDependents(compID string) []string {
	var dependents []string
	for id, deps := range r.depEdges {
