...
func (w *Workflows) provision(ctx workflow.Context, appID string, sandboxMode bool) error {
	...
	if currentApp.Org.OrgType != app.OrgTypeV2 {
		if err := w.provisionLegacy(ctx, currentApp.OrgID, appID, sandboxMode); err != nil {
