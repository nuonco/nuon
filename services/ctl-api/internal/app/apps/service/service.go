...
func (s *service) RegisterPublicRoutes(api *gin.Engine) error {
	...
	api.GET("/v1/apps/:app_id/config/:config_id", s.GetAppConfig) // DEPRECATED
	api.GET("/v1/apps/:app_id/configs/:config_id", s.GetAppAppConfig)
	api.PATCH("/v1/apps/:app_id/config/:config_id", s.UpdateAppConfig) // DEPRECATED
	api.PATCH("/v1/apps/:app_id/configs/:config_id", s.UpdateAppAppConfig)
	api.POST("/v1/apps/:app_id/config/:config_id/update-installs", s.UpdateAppConfigInstalls) // DEPRECATED
	api.POST("/v1/apps/:app_id/configs/:config_id/update-installs", s.UpdateAppAppConfigInstalls)
	api.GET("/v1/apps/:app_id/config/:config_id/graph", s.GetAppConfigGraph) // DEPRECATED
