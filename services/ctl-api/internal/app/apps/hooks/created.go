...
func (a *Hooks) startEventLoop(ctx context.Context, appID string, sandboxMode bool) error {
...
func (a *Hooks) Created(ctx context.Context, appID string, sandboxMode bool) {
