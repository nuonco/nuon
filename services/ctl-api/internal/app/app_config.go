...
type AppConfig struct {
	...
	EventAutomationRules       []EventAutomationRule       `json:"event_automation_rules,omitzero,omitempty" gorm:"constraint:OnDelete:CASCADE;" temporaljson:"event_automation_rules,omitzero,omitempty"`
