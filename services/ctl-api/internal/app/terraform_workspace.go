...
type TerraformWorkspace struct {
	...
	States      []TerraformWorkspaceState `faker:"-" json:"-" swaggerignore:"true" gorm:"constraint:OnDelete:CASCADE;"`
	LockHistory []TerraformWorkspaceLock  `faker:"-" json:"-" swaggerignore:"true" gorm:"foreignKey:WorkspaceID;references:ID;constraint:OnDelete:CASCADE;"`
}
