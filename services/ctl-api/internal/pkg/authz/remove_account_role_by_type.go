...
// RemoveAccountOrgRoleByType drops a single role binding, unlike
// RemoveAccountOrgRoles which clears every binding an account holds in an org.
// Callers narrowing an account's access need to keep its other roles.
