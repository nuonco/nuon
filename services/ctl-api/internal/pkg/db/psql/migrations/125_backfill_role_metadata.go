...
// Migration125BackfillRoleMetadata reconciles every org's managed roles with
...
func (m *Migrations) Migration125BackfillRoleMetadata(ctx context.Context, db *gorm.DB) error {
	const batchSize = 20
	var offset int
