...
func residentSkipAutoRetrySteps(deploy *app.InstallDeploy) []app.WorkflowStep {
...
func (e *FlowTestSuite) TestResidentColdRetryRewarms() {
	...
	flw, queueID := e.setupGroupedFlowTest(ctx, ownerID, ownerType, residentSkipAutoRetrySteps(deploy))
