...
func init() {
	...
	config.RegisterDefault("temporal_max_concurrent_workflows", 10000)
	config.RegisterDefault("temporal_max_concurrent_activity_task_pollers", 20)
	config.RegisterDefault("temporal_max_concurrent_workflow_task_pollers", 20)
...
type Config struct {
	...
	TemporalMaxConcurrentWorkflows           int    `config:"temporal_max_concurrent_workflows"`
