...
var globalEndpointList map[[2]string]struct{} = map[[2]string]struct{}{
	...
	{"GET", "/v1/customer-managed/installs/:install_id/releases"}:                                     {},
	{"GET", "/v1/customer-managed/installs/:install_id/release-updates"}:                              {},
	{"GET", "/v1/customer-managed/installs/:install_id/releases/:release_id"}:                         {},
	{"GET", "/v1/customer-managed/installs/:install_id/releases/:release_id/files/content"}:           {},
	{"GET", "/v1/customer-managed/installs/:install_id/workflows"}:                                    {},
	{"GET", "/v1/customer-managed/installs/:install_id/workflows/:workflow_id"}:                       {},
	{"GET", "/v1/customer-managed/installs/:install_id/workflows/:workflow_id/steps/:step_id/logs"}:   {},
	{"POST", "/v1/customer-managed/installs/:install_id/workflows/:workflow_id/steps/:step_id/retry"}: {},
	{"GET", "/v1/customer-managed/installs/:install_id/workflows/:workflow_id/steps/:step_id/approvals/:approval_id/contents"}:  {},
	{"POST", "/v1/customer-managed/installs/:install_id/workflows/:workflow_id/steps/:step_id/approvals/:approval_id/response"}: {},
