...
const COMMANDS: Record<string, string[] | ((args: string[]) => string[])> = {
  ...
  '/list': [
    ...
    '',
    '    ○ ai-config-generator  [coming-soon]',
    '      Generate Nuon configs with AI',
    '',
    '    ● multi-region-deploy  [beta]',
  ...
  '/status': (args: string[]) => {
    ...
    const statuses: Record<string, string[]> = {
      ...
      'multi-region-deploy': [
        ...
        '    Status: beta',
        '    Updated: 5 days ago',
        '    Features: Multi-region orchestration',
        '',
      ],
    }
...
const PROJECTS = ['customer-dashboard', 'ai-config-generator', 'multi-region-deploy']
...
export const Terminal = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('scroll-started', handleRadius50)
    return () => window.removeEventListener('scroll-started', handleRadius50)
  }, [])
  ...
  return (
    <div
      className={`w-[80%] mx-auto transition-all duration-1000 delay-500 relative z-10 ${
    ...
    >
      ...
      >
        ...
        <div className="relative h-[550px]">
          {/* WebGL Animation - Overlay on right 50% */}
          <div 
            className="absolute top-0 right-0 w-1/2 h-full pointer-events-none z-0"
            style={{ 
          ...
          <div
            ref={terminalRef}
            className="relative z-10 p-6 h-full overflow-y-auto text-sm flex flex-col"
          >
            {/* Welcome Text */}
            <div className="mb-6 max-w-[50%]">
              <div className="whitespace-pre mb-4">
                <div className="text-[#e5e5e5] font-semibold mb-2">Nuon Labs Terminal</div>
                <div className="text-[#808080] text-xs mb-4">Experimental BYOC Playground</div>
              </div>

              <div className="text-[#666666] text-xs space-y-1">
        ...
        <div className="px-5 py-5 border-t border-[#2a2a2a] bg-[#0d0d0d]">
          <form onSubmit={handleSubmit} className="flex gap-2 items-center text-base">
            <span className="text-[#f97316]">❯</span>
            <div className="flex-1 relative py-1">
              <span className="absolute left-0 top-1 pointer-events-none whitespace-pre">
              ...
              <input
                ...
                className="w-full bg-transparent outline-none text-transparent caret-[#f97316] text-base"
            ...
            {suggestion && (
              <span className="text-[#525252] text-xs">tab</span>
            )}
          </form>
          <div className="flex gap-4 mt-2 text-[11px] text-[#525252]">
