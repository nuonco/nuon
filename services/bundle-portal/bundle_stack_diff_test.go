...
func TestAddStackPropertyChanges(t *testing.T) {
	candidate := &day2.StackCandidate{Changes: []day2.StackChange{
	...
	require.Equal(t, []day2.StackPropertyChange{
...
func TestStackPropertyChangesCaptured(t *testing.T) {
	require.False(t, stackPropertyChangesCaptured(day2.StackCandidate{Changes: []day2.StackChange{{LogicalResourceID: "Runner"}}}))
	require.True(t, stackPropertyChangesCaptured(day2.StackCandidate{Changes: []day2.StackChange{{PropertyChanges: []day2.StackPropertyChange{{Path: "Properties.Image"}}}}}))
	require.True(t, stackPropertyChangesCaptured(day2.StackCandidate{Changes: []day2.StackChange{{PropertyChangesTruncated: true}}}))
}
