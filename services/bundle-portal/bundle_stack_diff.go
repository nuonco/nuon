...
func addStackPropertyChanges(candidate *operation.StackCandidate, beforeRaw, afterRaw []byte) error {
	...
	for i := range candidate.Changes {
		...
		var values []operation.StackPropertyChange
...
func stackPropertyChangesCaptured(candidate operation.StackCandidate) bool {
...
func diffStackValue(path string, before any, beforeSet bool, after any, afterSet bool, changes *[]operation.StackPropertyChange) {
	...
	change := operation.StackPropertyChange{Path: path}
	if beforeSet {
...
func diffStackMap(path string, before, after map[string]any, changes *[]operation.StackPropertyChange, childPath func(string, string) string) {
