...
func (r AdoptWaypointRunnerRequest) validate() error {
...
func (a *Activities) AdoptWaypointRunner(
	ctx context.Context,
	...
	if err := a.adoptWaypointRunner(ctx, client, req.OrgID); err != nil {
...
func (w *wpRunnerAdopter) adoptWaypointRunner(ctx context.Context, client waypointClientRunnerAdopter, orgID string) error {
