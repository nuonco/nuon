...
func (r GetWaypointServerCookieRequest) validate() error {
...
func (a *Activities) GetWaypointServerCookie(
	ctx context.Context,
...
func (w *wpServerCookieGetter) getWaypointServerCookie(
	ctx context.Context,
	client waypointClientServerConfigGetter,
) (string, error) {
