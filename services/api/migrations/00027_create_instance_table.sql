...
ALTER TABLE instances ADD CONSTRAINT fk_deployments_instances FOREIGN KEY (deploy_id) REFERENCES deploys(id);

ALTER TABLE instances ADD CONSTRAINT unq_build_deploy UNIQUE (install_id, build_id);
-- +goose StatementEnd
