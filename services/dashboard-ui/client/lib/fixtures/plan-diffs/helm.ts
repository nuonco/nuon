...
export const nginxIngressUpgradePlan = {
...
export const certManagerInstallPlan = {
...
export const postgresOperatorUpgradePlan = {
...
export const prometheusStackChangePlan = {
...
export const redisClusterRollbackPlan = {
...
export const longAnnotationsAndEnvVarsPlan = {
...
export const singleImageTagChangePlan = {
...
export const largeDeploymentSingleChangePlan = {
  plan: `apps, ctl-api-auth, Deployment (apps/v1) to be changed
Plan: 0 to add, 1 to change, 0 to destroy`,
  op: 'upgrade',
  helm_content_diff: [
...
export const largeDeploymentScatteredChangesPlan = {
  plan: `apps, ctl-api-auth, Deployment (apps/v1) to be changed
Plan: 0 to add, 1 to change, 0 to destroy`,
  op: 'upgrade',
  helm_content_diff: [
