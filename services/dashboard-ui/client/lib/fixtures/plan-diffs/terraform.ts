...
export const iamRoleWithNestedPolicyPlan = {
  resource_changes: [
    {
...
export const eksClusterCreatePlan = {
  resource_changes: [
    {
      ...
      change: {
        ...
        after: {
          ...
          encryption_config: {
            provider: {
              key_arn: 'arn:aws:kms:us-west-2:123456789012:key/abc-def-123',
            },
            resources: ['secrets'],
          },
...
export const securityGroupUpdatePlan = {
  resource_changes: [
    {
...
export const noOpAndReadResourcesPlan = {
  resource_changes: [
    {
...
export const replaceResourcesPlan = {
  resource_changes: [
    {
      address: 'aws_instance.web',
      type: 'aws_instance',
...
export const mixedWithNoOpPlan = {
  resource_changes: [
    {
...
export const rbacArrayNoisePlan = {
  resource_changes: [
    {
...
export const azureNoOpWithCosmeticDriftPlan = {
  resource_drift: [
    {
...
export const driftDetectedPlan = {
  resource_drift: [
    {
...
export const kubectlManifestDeploymentPlan = {
  resource_changes: [
    {
      ...
      change: {
        ...
        before: {
          ...
          live_manifest_incluster:
            'sha256:a3f8c2e1d09b4f7e6c5a2b1d8e3f9c4a7b2e5d8f1c6a9b3e7f2d5c8a1b4e7f0c3d6a9b2e5c8f1a4b7e0d3c6f9a2b5e8c1d4f7a0b3e6c9d2f5a8b1e4c7d0f3a6b9e2c5d8f1a4b7e0c3d6f9a2b5e8c1',
          force_new: false,
        ...
        after: {
          ...
          live_manifest_incluster:
            'sha256:b4a9d3f2e1c8b5a2e9d6c3f0a7b4e1d8c5f2a9b6e3c0d7f4a1b8e5c2d9f6a3b0e7c4d1f8a5b2e9c6d3f0a7b4e1d8c5f2a9b6e3c0d7f4a1b8e5c2d9f6a3b0e7',
          force_new: false,
          server_side_apply: true,
        },
      },
    },
    {
      ...
      change: {
        ...
        before: {
          ...
          live_manifest_incluster:
            'sha256:c1e4a7b0d3f6c9a2e5b8d1f4c7a0e3b6d9f2c5a8e1b4d7f0c3a6e9b2d5f8c1a4e7b0d3f6c9a2e5b8d1f4c7a0e3b6d9f2c5a8e1b4d7f0c3a6e9b2d5f8c1a4',
        },
        after: {
          ...
          live_manifest_incluster:
            'sha256:d2f5b8e1a4c7d0f3b6e9c2d5f8a1b4e7c0d3f6a9b2e5c8d1f4a7b0e3c6d9f2a5b8e1c4d7f0a3b6e9c2d5f8a1b4e7c0d3f6a9b2e5c8d1f4a7b0e3c6d9f2a5',
        },
      },
    },
  ],
...
export const driftWithChangesAndOutputsPlan = {
  resource_drift: [
    {
      address: 'aws_autoscaling_group.web',
      type: 'aws_autoscaling_group',
