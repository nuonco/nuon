...
export const deploymentUpgradePlan = {
...
export const deleteResourcesPlan = {
...
export const mixedOperationsPlan = {
  plan: 'k8s-mixed-ops',
  op: 'apply',
  k8s_content_diff: [
    {
...
export const longConfigMapEntriesPlan = {
...
export const unchanged = (payload: string) => ({ type: 0, payload, path: '' })
export const removed = (payload: string) => ({ type: 1, payload, path: '' })
export const added = (payload: string) => ({ type: 2, payload, path: '' })

export const envVarLines = (count: number, offset = 0) =>
...
export const largeSingleChangePlan = {
...
export const largeScatteredChangesPlan = {
