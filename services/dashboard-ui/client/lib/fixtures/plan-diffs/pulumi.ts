...
export const s3BucketCreatePlan: TPulumiPlan = {
  stdout: '',
  stderr: '',
...
export const ecsServiceUpdatePlan: TPulumiPlan = {
  stdout: '',
  stderr: '',
...
export const databaseReplacePlan: TPulumiPlan = {
  stdout: '',
  stderr: '',
  change_summary: {
...
export const mixedInfraChangesPlan: TPulumiPlan = {
  stdout: '',
  stderr: '',
...
export const largeEksClusterDeployPlan: TPulumiPlan = {
  stdout: '',
  stderr: '',
...
export const kubernetesAppMigrationPlan: TPulumiPlan = {
  stdout: '',
  stderr: '',
  change_summary: {
    create: 12,
...
export const azureCosmeticUpdatesPlan: TPulumiPlan = {
  stdout: '',
  stderr: '',
...
export const rbacArrayNoisePlan: TPulumiPlan = {
  stdout: '',
  stderr: '',
...
export const longPolicyAndConfigValuesPlan: TPulumiPlan = {
  stdout: '',
  stderr: '',
  ...
  resource_changes: [
              ...
              Statement: [
                {
                  ...
                  Resource:
                    'arn:aws:secretsmanager:us-west-2:123456789012:secret:production/api/*',
                },
              ],
            }),
          },
        ...
        assumeRolePolicy: JSON.stringify({
          ...
          Statement: [
            ...
            },
            {
              Effect: 'Allow',
              Principal: {
                AWS: 'arn:aws:iam::123456789012:role/production-deploy-role',
              },
              Action: 'sts:AssumeRole',
              Condition: {
                StringEquals: { 'sts:ExternalId': 'nuon-deploy-production' },
              },
            },
          ],
        }),
    ...
    },
    {
      ...
      detailed_diff: {
        ...
        'schema[2].stringAttributeConstraints.maxLength': {
          kind: 'update',
          inputDiff: true,
        },
      },
      old_inputs: {
        ...
        lambdaConfig: {
          preTokenGeneration:
            'arn:aws:lambda:us-west-2:123456789012:function:production-pre-token-gen:3',
          preSignUp:
            'arn:aws:lambda:us-west-2:123456789012:function:production-pre-signup-validation:7',
          postConfirmation:
            'arn:aws:lambda:us-west-2:123456789012:function:production-post-confirmation-welcome:2',
        },
        ...
        logoutUrls: [
          'https://app.acme.io/auth/logout',
          'https://staging.acme.io/auth/logout',
        ],
      ...
      new_inputs: {
        ...
        lambdaConfig: {
          preTokenGeneration:
            'arn:aws:lambda:us-west-2:123456789012:function:production-pre-token-gen:4',
          preSignUp:
            'arn:aws:lambda:us-west-2:123456789012:function:production-pre-signup-validation:7',
          postConfirmation:
            'arn:aws:lambda:us-west-2:123456789012:function:production-post-confirmation-welcome:2',
    ...
    },
    {
      ...
      new_inputs: {
        ...
        tags: {
          Environment: 'production',
          ManagedBy: 'pulumi',
          Cluster: 'production-eks-cluster-us-west-2',
        },
      },
    },
  ],
...
export const withDiagnosticsPlan: TPulumiPlan = {
  stdout: '',
  stderr: '',
