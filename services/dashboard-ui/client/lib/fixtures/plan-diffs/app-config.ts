...
export const appConfigMockSections: TAppConfigDiffSection[] = [
  {
    name: 'Components',
...
export const appConfigAllSections: TAppConfigDiffSection[] = [
  appConfigMockSections[0],
  appConfigMockSections[1],
  {
    name: 'Install inputs',
    sectionKey: 'inputs',
    grouped: true,
