...
export const SpotlightTrigger = () => {
  ...
  return (
    <button
      ...
      className="hidden md:flex items-center gap-3 h-9 pl-3 pr-2 py-2 w-[240px] border border-cool-grey-500/24 rounded-lg bg-white dark:bg-dark-grey-900 text-cool-grey-500 text-sm font-normal leading-[21px] tracking-[-0.2px] cursor-pointer transition-colors overflow-hidden"
    >
