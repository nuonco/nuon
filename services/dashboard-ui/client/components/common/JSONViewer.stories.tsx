  ...
  data: {
    users: [
      ...
      },
      {
        ...
        name: 'Bob Smith',
        role: 'user',
        last_login: '2024-03-19T16:42:00Z',
      },
      {
        id: 3,
        name: 'Carol Davis',
        role: 'moderator',
        last_login: '2024-03-20T11:30:00Z',
      },
    ],
    pagination: {
      page: 1,
  ...
  <div className="space-y-6">
    <div className="space-y-3">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        JSONViewer provides an interactive way to explore complex JSON data
        structures. Unlike static code blocks, users can collapse and expand
        nodes, making it perfect for debugging, API responses, and configuration
        management.
      </p>
    </div>
...
export const ConfigurationData = () => (
  <div className="space-y-6">
    <div className="space-y-3">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        JSONViewer excels at displaying complex configuration objects with
        nested structures. The interactive nature makes it easy to navigate
        through database settings, feature flags, and service configurations.
      </p>
    </div>
...
export const APIResponses = () => (
  <div className="space-y-6">
    <div className="space-y-3">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        Perfect for debugging API responses and understanding complex data
        structures returned from backend services. The interactive format makes
        it easy to drill down into specific data points.
      </p>
    </div>
    ...
    <div className="space-y-4">
      ...
      <div className="max-w-4xl">
        <JSONViewer data={apiResponse} showSize={true} showToolbar={true} />
      </div>
      <Text variant="subtext" theme="neutral">
...
export const CustomizationOptions = () => (
  <div className="space-y-6">
    ...
    <div className="text-sm text-gray-600 dark:text-gray-400 mt-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-md">
      ...
      <ul className="mt-2 space-y-1 list-disc list-inside">
        <li>
          <code>expanded</code>: Control how many levels are expanded by default
          (number) or fully expand/collapse (boolean)
        </li>
        <li>
          <code>indent</code>: Number of spaces for indentation (default: 2)
        </li>
        <li>
          <code>showDataTypes</code>: Show/hide data type indicators
        </li>
        <li>
          <code>showSize</code>: Show/hide object and array sizes
        </li>
        <li>
          <code>showCopy</code>: Enable/disable copy to clipboard
        </li>
        <li>
          <code>showToolbar</code>: Enable interactive toolbar with
          expand/collapse controls
        </li>
        <li>
          <code>expandIconType</code>: Icon style for expand/collapse
          (&lsquo;square&rsquo;, &lsquo;circle&rsquo;, &lsquo;arrow&rsquo;)
        </li>
      </ul>
    </div>
  </div>
