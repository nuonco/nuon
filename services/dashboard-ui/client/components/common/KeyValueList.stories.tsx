...
export const JsonSupport = () => (
  <div className="space-y-6">
    <div className="space-y-3">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        KeyValueList automatically detects JSON objects and arrays, rendering
        them in formatted CodeBlock components with syntax highlighting. This is
        perfect for displaying configuration objects, API responses, and complex
        data structures.
      </p>
    </div>
    ...
    <div className="space-y-4">
        ...
        <KeyValueList
          values={[
            ...
            },
            {
              key: 'feature_flags',
              value: JSON.stringify(
                ['new_ui_enabled', 'advanced_analytics', 'beta_features'],
                null,
                2
              ),
              type: 'array',
      ...
      <Text variant="subtext" theme="neutral">
        Objects and arrays are automatically rendered with JSON syntax
        highlighting
      </Text>
    </div>
