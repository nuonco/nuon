...
export const ComplexData = () => {
  const complexData = [
    ...
    },
    {
      name: 'Health Check',
      value: (
        <Text theme="success" weight="strong">
          Healthy
        </Text>
      ),
      updated: 'Just now',
...
export const WithLongContent = () => {
  const longContentData = [
    ...
    },
    {
      ...
      value:
        'NODE_ENV=production, DEBUG=false, API_URL=https://api.example.com/v1, DATABASE_URL=postgresql://user:pass@host:5432/db',
      category: 'Configuration',
    },
    {
      property: 'Command',
      value:
        'npm start --production --max-old-space-size=2048 --optimize-for-size',
      category: 'Runtime',
    },
  ]
...
export const BalancedColumns = () => (
  <PropertyGrid
    values={[
      ...
      {
        application_name: 'Long Application Name Here',
        deployment_status: 'Running',
        last_deploy: '2024-01-09',
      },
    ]}
