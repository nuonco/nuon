...
const artifactHref = (
  artifact: TAirgapBundleArtifact,
  orgId?: string,
  appId?: string
) => {
...
export const BundleContentsTable = ({
  ...
  artifacts: TAirgapBundleArtifact[]
  orgId?: string
  appId?: string
}) => {
  ...
  const columns: ColumnDef<TAirgapBundleArtifact>[] = useMemo(
    () => [
      {
        header: 'Name',
        ...
        cell: (props) => {
          ...
          const href = artifactHref(props.row.original, orgId, appId)
          return (
