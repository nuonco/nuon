  ...
  const openPanel = () => {
    addPanel(
      <Panel heading="Welcome to Panels">
        <div className="p-6">
          <Text className="mb-4">
            This is a simple panel example that demonstrates basic slide-out
            functionality. Panels appear from the right side and overlay the
            main content.
          </Text>
          <Text variant="subtext" theme="neutral">
            You can close this panel by clicking the X button, pressing Escape,
      ...
      <Panel heading="Default Panel">
        <div className="p-6">
          <Text className="mb-4">
            ...
            user profiles, and detailed information that doesn't require a lot
            of space.
          </Text>
            ...
            <Card>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-3 bg-blue-50 rounded">
                  <Text variant="base" className="text-blue-600 font-semibold">
                    42
                  </Text>
                  <Text variant="subtext">Active Tasks</Text>
                </div>
                <div className="text-center p-3 bg-green-50 rounded">
                  <Text variant="base" className="text-green-600 font-semibold">
                    128
                  </Text>
      ...
      <Panel size="full" heading="Full-Width Panel">
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card>
              <Text variant="base" className="mb-3">
                Performance
              </Text>
      ...
      <Panel heading="Project Details" size="half">
        <div className="p-6">
          <div className="space-y-6">
            <div>
              <Text variant="base" className="font-semibold mb-2">
                Project Overview
              </Text>
              <Text variant="subtext" theme="neutral">
                A comprehensive dashboard redesign focused on improving user
                experience and streamlining key workflows.
              </Text>
            </div>

            <div>
              <Text variant="base" className="font-semibold mb-3">
                Team Members
              </Text>
              <div className="space-y-2">
      ...
      <Panel heading="Application Settings" size="full">
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card>
              <Text variant="base" className="font-semibold mb-4">
                General
              </Text>
              <div className="space-y-3">
                <div>
    ...
    <div className="space-y-6">
      <div className="space-y-3">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          The Panel component creates slide-out overlays that appear from the
          right side of the screen. Panels are ideal for secondary content,
          detailed views, forms, and contextual information that doesn't require
          a full page navigation. They maintain context while providing focused
          interaction space.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <Text variant="subtext" theme="neutral">
          Click the button above to see a basic panel with slide-out
          functionality
        </Text>
      </div>
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400 mt-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-md">
        ...
        <ul className="mt-2 space-y-1 list-disc list-inside">
          ...
          <li>
            Portal rendering for correct z-index layering and focus management
          </li>
          <li>
            Three size options: default (fixed), half-width, and full-width
          </li>
  ...
  <SurfacesProvider>
    <div className="space-y-6">
      <div className="space-y-3">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          Panels support three different size variants to accommodate different
          content types and use cases. The{' '}
      ...
      <div className="space-y-4">
        ...
        <Text variant="subtext" theme="neutral">
          Try different panel sizes to see how they accommodate various content
          layouts
        </Text>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
          <div className="p-3 border rounded-lg">
            ...
            <span className="block text-gray-600 dark:text-gray-400 mt-1">
              Fixed width (w-104) - Perfect for forms, user profiles, and
              focused content
            </span>
          </div>
          <div className="p-3 border rounded-lg">
            ...
            <span className="block text-gray-600 dark:text-gray-400 mt-1">
              50% screen width - Ideal for side-by-side workflows and detailed
              views
            </span>
          </div>
          <div className="p-3 border rounded-lg">
            ...
            <span className="block text-gray-600 dark:text-gray-400 mt-1">
              100% screen width - Great for dashboards, settings, and complex
              layouts
            </span>
          </div>
        </div>
  ...
  <SurfacesProvider>
    <div className="space-y-6">
      <div className="space-y-3">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          Panels excel at providing contextual interfaces that don't disrupt the
          main workflow. They're commonly used for editing content, displaying
          details, configuring settings, and managing user accounts while
          keeping the primary interface visible and accessible.
        </p>
      </div>
  ...
  return (
    <div>
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400 mt-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-md">
        ...
        <ul className="mt-2 space-y-1 list-disc list-inside">
          <li>
            Use panels for secondary content that supports the main interface
          </li>
          <li>
            Choose appropriate sizes based on content complexity and user needs
          </li>
          <li>
            Provide clear headings that describe the panel's purpose and content
          </li>
          <li>
            Keep panel content focused and avoid overwhelming users with
            information
          </li>
          <li>
            Consider mobile responsiveness - panels adapt automatically to
            smaller screens
          </li>
          <li>
            Ensure proper keyboard navigation and screen reader accessibility
          </li>
        </ul>
      </div>
    </div>
