...
const isEligibleInstall = (install: TInstall) =>
  install.operating_model?.connectivity === 'connected' &&
  install.operating_model?.release_selection === 'vendor_proposed' &&
  install.operating_model?.approval_authority === 'customer'
