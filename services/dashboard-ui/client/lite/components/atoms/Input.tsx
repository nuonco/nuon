...
export const FIELD_CONTROL_CLASSES =
  'w-full rounded-lg border border-field-border bg-field-bg text-field-text outline-none transition-colors placeholder:text-field-placeholder not-disabled:hover:bg-field-bg-hover focus-ring focus-ring-tight aria-invalid:border-field-invalid disabled:cursor-not-allowed disabled:opacity-50'
