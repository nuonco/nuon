...
const KNOWN_GAPS: Record<string, string[]> = {
  ...
  'molecules/ComponentType': ['iconSize'],
  'molecules/Diff': ['className'],
  'molecules/DiffSummary': ['className'],
  'molecules/Disclosure': ['headerClassName', 'contentClassName', 'children'],
  'molecules/DisclosureGroup': ['children'],
  'molecules/Field': ['loading', 'loadingWidth', 'children'],
  'molecules/FilterMenu': ['label', 'closeOnReset'],
  'molecules/FormRadioGroup': [
    'options',
    'label',
    'description',
    'disabled',
  ...
  'molecules/Menu': ['initialFocusRef'],
  'molecules/NavLink': ['onNavigate'],
  'molecules/Pagination': ['label'],
  'molecules/SearchInput': ['leading', 'inputClassName'],
  'molecules/Select': [
    'placeholder',
    'searchPlaceholder',
    'emptyMessage',
  ...
  'molecules/SubNav': ['items', 'label'],
  'molecules/SwitcherMenu': [
    'searchLabel',
    'searchPlaceholder',
    'emptyTitle',
    'errorTitle',
  ...
  'molecules/TableViewToggle': ['label', 'className'],
