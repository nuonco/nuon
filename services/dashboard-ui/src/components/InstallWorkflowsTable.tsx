...
export interface IInstallWorkflowsTable {
  installId: string
  orgId: string
  workflows: Array<TWorkflow>
}

export const InstallWorkflowsTable: FC<IInstallWorkflowsTable> = ({
  installId,
  orgId,
  workflows,
}) => {
    ...
    () => [
      {
        ...
        cell: (props) => (
          <div className="flex flex-col gap-2">
            <Link
              href={`/${orgId}/installs/${installId}/workflows/${props.row.original.id}`}
            >
