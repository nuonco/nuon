import { SectionHeader } from '@/components/old/Card'
import { JsonView } from '@/components/old/Code'
import { Empty } from '@/components/old/Empty'
import { DataTable } from '@/components/old/InstallSandbox/Table'
import { Tabs, Tab } from '@/components/old/InstallSandbox/Tabs'
import { Text, Code } from '@/components/old/Typography'
import { getToken } from '@/components/old/admin-actions'
import {
  getTerraformState,
  getTerraformStates,
      ...
      <SectionHeader
        ...
        actions={
          <div className="flex items-center gap-4">
            {lock ? <UnlockModal workspace={workspace} lock={lock} /> : null}
            <BackendModal
              orgId={orgId}
              workspace={workspace}
