...
export const SemanticRoles = () => (
  <div className="flex flex-col gap-4">
    ...
    <Text role="paragraph" variant="body">
      This is a semantic paragraph element
    </Text>
...
export const Combinations = () => (
  <div className="flex flex-col gap-4">
    <Text variant="h1" weight="stronger" theme="brand">
      Strong brand heading
    </Text>
    <Text variant="body" theme="neutral" weight="normal">
      Neutral body text
    </Text>
    <Text variant="label" weight="strong" theme="info" family="mono">
      MONO INFO LABEL
    </Text>
    <Text variant="subtext" theme="error">
      Error subtext message
    </Text>
    <Text role="heading" level={2} variant="h2" theme="success" weight="strong">
...
export const CustomStyling = () => (
  <div className="flex flex-col gap-4">
    ...
    <Text variant="body" className="max-w-xs truncate">
      This is very long text that will be truncated when it exceeds the maximum
      width
    </Text>
  </div>
)
