  ...
  <div className="space-y-6">
    <div className="space-y-3">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        LabeledValue provides a consistent layout for displaying labeled
        content with proper spacing and typography. It's perfect for forms,
      ...
      <div className="space-y-4 max-w-2xl">
        ...
        <LabeledValue label="Tags">
          <div className="flex flex-wrap gap-2">
            <Badge theme="brand" size="sm">Frontend</Badge>
            <Badge theme="info" size="sm">React</Badge>
            <Badge theme="neutral" size="sm">TypeScript</Badge>
          </div>
        </LabeledValue>
...
export const FormLayouts = () => (
  <div className="space-y-6">
    <div className="space-y-3">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        LabeledValue is commonly used in form layouts, settings panels,
        and configuration interfaces where labels need to be clearly
        associated with input fields or display values.
      </p>
    </div>
    ...
    <div className="space-y-4">
      ...
      <div className="p-4 border rounded-lg max-w-lg">
        <Text variant="h3" weight="stronger" className="mb-4">Profile Settings</Text>
        <div className="space-y-4">
    ...
    <div className="space-y-4">
      ...
      <div className="p-4 border rounded-lg max-w-lg">
        <Text variant="h3" weight="stronger" className="mb-4">System Configuration</Text>
        <div className="space-y-3">
...
export const ResponsiveLayouts = () => (
  <div className="space-y-6">
    <div className="space-y-3">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        LabeledValue works well in responsive grid layouts and can adapt
        to different screen sizes while maintaining proper label-content
        relationships.
      </p>
    </div>
    ...
    <div className="space-y-4">
      ...
      <div className="p-4 border rounded-lg">
        <Text variant="h3" weight="stronger" className="mb-4">Project Details</Text>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <LabeledValue label="Deployment">
            <div className="flex items-center gap-2">
              <Badge theme="info" size="sm">v2.1.0</Badge>
...
export const UsageExamples = () => (
  <div className="space-y-6">
    <div className="space-y-3">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        LabeledValue is versatile and works well in settings panels,
        profile pages, configuration displays, and any interface requiring
        labeled content presentation.
      </p>
    </div>
    ...
    <div className="space-y-4">
      ...
      <div className="p-4 border rounded-lg">
        <Text variant="h3" weight="stronger" className="mb-4">API Endpoint Details</Text>
        <div className="space-y-3 max-w-2xl">
          ...
          <LabeledValue label="Status Codes">
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                <Badge theme="success" size="sm">200</Badge>
                <Text variant="subtext">Success</Text>
              </div>
              <div className="flex items-center gap-2">
                <Badge theme="warn" size="sm">400</Badge>
                <Text variant="subtext">Bad Request</Text>
              </div>
              <div className="flex items-center gap-2">
                <Badge theme="error" size="sm">401</Badge>
    ...
    <div className="space-y-4">
      ...
      <div className="p-4 border rounded-lg">
        <Text variant="h3" weight="stronger" className="mb-4">Server Information</Text>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <LabeledValue label="Memory Usage">
            <div className="flex items-center gap-2">
              ...
              <Badge theme="success" size="sm">39%</Badge>
            </div>
          </LabeledValue>
        </div>
      </div>
    ...
    <div className="text-sm text-gray-600 dark:text-gray-400 mt-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-md">
      ...
      <ul className="mt-2 space-y-1 list-disc list-inside">
        ...
        <li>Choose appropriate content types (text, badges, buttons) for the context</li>
