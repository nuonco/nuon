...
export type TBadgeTheme = "neutral" | "brand" | "success" | "warn" | "error" | "info";
...
const THEME_CLASSES: Record<NonNullable<IBadge["theme"]>, string> = {
  brand: "bg-primary-50 !border-primary-200 text-primary-600 dark:bg-[#1B1026] dark:!border-[#351F4D] dark:text-primary-400",
  neutral:
