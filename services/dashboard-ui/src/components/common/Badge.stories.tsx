  ...
  <div className="space-y-6">
    <div className="space-y-3">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        ...
        dark mode styling and maintains accessibility contrast ratios.
      </p>
    </div>
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
        ...
        <div>
          <strong>default:</strong> Standard grey colors (default if no theme
          specified)
        </div>
      </div>
    </div>
  ...
  <div className="space-y-6">
    <div className="space-y-3">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        ...
        -0.2px letter spacing for improved readability.
      </p>
    </div>
  ...
  <div className="space-y-6">
    <div className="space-y-3">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        ...
        prop controls the visual style and typography of the badge.
      </p>
    </div>
    ...
    <div className="space-y-4">
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400 mt-3">
        <strong>Use case:</strong> The{' '}
        <code className="px-2 py-0.5 bg-gray-100 dark:bg-gray-800 rounded text-xs">
          code
        </code>{' '}
        variant is ideal for displaying version numbers, API endpoints, or
