...
export default async function InstallDeployDashboard({ params }) {
  const orgId = params?.['org-id']
  const installId = params?.['install-id']
  const installComponentId = params?.['component-id']
  const deployId = params?.['deploy-id']
  ...
  return (
    <Page
      ...
      links={[
        { href: orgId },
        { href: installId },
        { href: 'components/' + installComponentId, text: installComponentId },
