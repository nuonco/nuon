...
export const CreateBranchModal = ({
  ...
  const formatError = (err: any): string => {
    ...
    return err.user_error || err.error || err.description || err.message || 'An error occurred'
  }
              ...
              <>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {loadingRepos ? (
                    ...
                    <Banner theme="warning">
                      No connected repositories found. Please update your GitHub connection to grant access to repositories.
                    </Banner>
                  ) : (
                    <select
                      id="repo"
                      ...
                      className="px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                      required={useVcs}
                      disabled={isLoading || loadingRepos || loadingBranches || !useVcs}
                    >
