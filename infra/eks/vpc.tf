locals {
  networks = {
    ...
    stage-nuon = {
      cidr            = "10.130.0.0/16"
      public_subnets  = ["10.130.0.0/26", "10.130.0.64/26", "10.130.0.128/26"]
      private_subnets = ["10.130.128.0/23", "10.130.130.0/23", "10.130.132.0/23"]
    }
    prod-nuon = {
      cidr            = "10.131.0.0/16"
      public_subnets  = ["10.131.0.0/26", "10.131.0.64/26", "10.131.0.128/26"]
      private_subnets = ["10.131.128.0/23", "10.131.130.0/23", "10.131.132.0/23"]
    }
    ...
    runners-stage-main = {
      ...
      private_subnets = ["10.135.128.0/23", "10.135.130.0/23", "10.135.132.0/23"]
    }
