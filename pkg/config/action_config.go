...
type ActionConfig struct {
	...
	KubeconfigEnabled *bool `mapstructure:"kubeconfig_enabled,omitempty" toml:"kubeconfig_enabled,omitempty"`
}
...
func (a ActionConfig) JSONSchemaExtend(schema *jsonschema.Schema) {
	NewSchemaBuilder(schema).
		...
		Field("kubeconfig_enabled").Short("whether to fetch and inject kubeconfig for this action").
