...
func parseDir(ctx context.Context, parseCfg ParseConfig, source *sourceCapture) (*ParseResult, error) {
	...
	if source != nil && appCfg.CustomerManaged != nil && source.err != nil {
		return nil, ParseErr{
...
func sourceMemberIdentity(group, path string, value any) (string, string) {
	...
	switch group {
	case "components":
		kind, identityField = "component", "Name"
	case "actions":
		kind, identityField = "action", "Name"
	case "runbooks":
		kind, identityField = "runbook", "Name"
	case "permissions":
		kind, identityField = "permission", "Type"
	default:
		return "", ""
	}
	...
	field := reflected.FieldByName(identityField)
