...
type PublicRepoConfig struct {
	Repo      string `json:"Repo" mapstructure:"repo,omitempty" toml:"repo,omitempty" jsonschema:"required"`
	Directory string `json:"Directory" mapstructure:"directory,omitempty" toml:"directory,omitempty" jsonschema:"required"`
	Branch    string `json:"Branch" mapstructure:"branch,omitempty" toml:"branch,omitempty" jsonschema:"required"`
}
