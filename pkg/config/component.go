...
func (c Component) JSONSchemaExtend(schema *jsonschema.Schema) {
	NewSchemaBuilder(schema).
		...
		Field("labels").Short("key/value labels for the component").
		Long("Map of key/value string labels used to organize and filter components. Labels are metadata only and do not affect deployment").
