...
func (s sync) iamPolicyToRequest(policy config.AppAWSIAMPolicy) *models.ServiceAppAWSIAMPolicyConfig {
...
func (s sync) iamRoleToRequest(role *config.AppAWSIAMRole) *models.ServiceAppAWSIAMRoleConfig {
