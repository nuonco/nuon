...
const (
	...
	PlanEnvelopeMediaType    = "application/vnd.nuon.airgap.plan.v1+json"
	BundleArtifactType       = "application/vnd.nuon.airgap.bundle.v1"
	RunnerBinaryArtifactType = "application/vnd.nuon.airgap.runner-binary.v1"
