...
// Cache manages JWKS providers for multiple cloud providers with caching
type Cache struct {
...
func (c *Cache) GetProvider(ctx context.Context, issuerURL string) (*jwks.CachingProvider, error) {
