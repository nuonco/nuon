...
func TestGenerateExamples(t *testing.T) {
	...
	// gets the default max-attempts cap (no schedule-to-close: a per-execution
	// timeout timer at a 24h horizon floods the temporal DB); ComplexActivity
	// keeps its explicit 1h.
