...
func NewAppBranchRunComparisonID() string {
...
func NewInstallManagementPolicyVersionID() string {
	return shortid.NewNanoID("imp")
}
...
func NewInstallConnectionReportID() string {
	return shortid.NewNanoID("icr")
}
