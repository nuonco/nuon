...
Before components can be deployed to installs, they are built into OCI artifacts by the Control Plane. All installs of an app share the same artifacts, and the Control Plane is the only part of the platform that touches your source code.

<Note>Build artifacts are stored as OCI images in your cloud registry.</Note>
