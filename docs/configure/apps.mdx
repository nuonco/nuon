...
Nuon apps allow you to create dependencies between components and exposes a rich configuration language to share outputs between components for configuration. Read more in our [interpolation guide](./../variable-interpolation).
...
Read more about app runner config [here](./app-runners).
