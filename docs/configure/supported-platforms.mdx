...
You can configure any serverless infrastructure using [terraform components](./terraform-components), and can model your container images using either [docker](./docker-image-components) or [external](./external-image-components) image components.
...
You can provision custom IAC resources on any platform using a [terraform component](./terraform-component).
