...
- A VPC, with the [public and private subnets tagged](/concepts/sandboxes#aws-ecs-byovpc) so our sandbox can find them.
...
- An [Install](/concepts/installs), using our [AWS ECS BYOVPC sandbox](/concepts/sandboxes#aws-ecs-byovpc)
