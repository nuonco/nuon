...
* can use your existing application and infrastructure code to cre
...
even provided by customers (by creating a [custom sandbox](./configure/sandboxes#custom-sandboxes).
...
Nuon deploys a [runner](./configure/runners.mdx) into each install to manage it. The runner is responsible for the
following:
