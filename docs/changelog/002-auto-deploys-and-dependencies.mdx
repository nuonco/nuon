...
![auto deploy](./changelog/images/002_auto_deploy.png)

Now, when you create an app using the `nuon` cli, an [an sdk](./guides/sdk_integration.md), or using [an installer](./guides/app_installers.mdx) - each component in the app will
...
![dependency errors](./changelog/images/002_dependency_cycle.png)
