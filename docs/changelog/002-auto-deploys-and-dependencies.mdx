...
Now, when you create an app using the `nuon` cli, an [an sdk](../guides/sdk-integration), or using [an installer](../guides/creating-an-installer) - each component in the app will
