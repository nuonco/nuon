...
![runner config](./changelog/images/003_runner_config.png)
...
![install ids](./changelog/images/003_install_ids.png)

Now, you can _select_ an install, and it will automatically be pinned for any commands:

![install ids](./changelog/images/003_install_id_select.png)
