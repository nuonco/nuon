...
description: Define break-glass actions that customers can opt into to grant temporary elevated access during incidents — fully audited and scoped per operation.
boost: 0.4
---
