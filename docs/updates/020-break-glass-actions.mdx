...
description: 'October 7, 2025 release: define break-glass actions that customers can enable on demand to grant vendors emergency, audited access into a running install.'
boost: 0.4
---
