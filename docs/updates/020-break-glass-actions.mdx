...
description: "Break-glass actions let customers explicitly enable elevated-permission Nuon actions for emergency operations — plus other release improvements."
boost: 0.4
---
