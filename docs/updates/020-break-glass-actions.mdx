...
description: 'Define Nuon Actions that use break-glass IAM roles for privileged operations — elevated access for emergencies while keeping default workflows least-privilege.'
boost: 0.4
---
