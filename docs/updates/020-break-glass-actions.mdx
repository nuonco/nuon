...
description: "Nuon adds break-glass actions: define elevated operational actions that customers can enable on demand for emergency access to their cloud accounts."
boost: 0.4
---
