...
description: 'Improved secret rotation flows, automatic retries for failed workflow steps, and a series of stability fixes for runners and the dashboard UI.'
boost: 0.4
---
