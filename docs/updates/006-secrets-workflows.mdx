...
description: 'Improved unique secret naming, better CloudFormation stack expiration errors, and workflow retries that resume from the failed step instead of restarting.'
boost: 0.4
---
