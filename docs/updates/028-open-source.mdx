---
title: "Nuon is now open source"
description: "Changelog 028: The core Nuon platform is now open source, plus new features and improvements across the control plane, runner, CLI, and dashboard."
boost: 0.4
---
