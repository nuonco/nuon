...
description: 'Action triggers for lifecycle events, improved app config validation, default secret values, and other improvements across the Nuon dashboard and CLI.'
boost: 0.4
---
