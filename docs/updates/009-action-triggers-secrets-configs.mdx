...
description: 'June 5, 2025 release: action triggers, improved config sync ergonomics, default secrets, and several smaller dashboard and CLI quality-of-life improvements.'
boost: 0.4
---
