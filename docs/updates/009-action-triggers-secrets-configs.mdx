---
title: "Action triggers, configs, and default secrets"
description: "Changelog 009: Adds action triggers tied to lifecycle events, improvements to install configs, and the ability to set default values on app secrets."
boost: 0.4
---
