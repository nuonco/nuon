...
description: "Nuon adds action triggers, improved config syncing, and default secret values to streamline how vendors define and operate customer installs."
boost: 0.4
---
