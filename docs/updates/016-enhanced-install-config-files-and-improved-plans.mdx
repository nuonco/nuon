---
title: "Enhanced install configs and better plans"
description: "Changelog 016: Enhanced install config files with richer schema validation, plus improvements to Terraform and Helm plan output across workflows."
boost: 0.4
---
