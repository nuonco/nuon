...
description: 'August 2025 release: directory and file-level install config file syncing, clearer Helm plan diffs, and optimized state management for faster workflows.'
boost: 0.4
---
