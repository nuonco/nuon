...
description: Directory- and file-level install config file syncing, clearer Helm diffs during approvals, and improved workflow performance from optimized state management.
boost: 0.4
---
