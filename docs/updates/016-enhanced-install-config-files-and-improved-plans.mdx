...
description: 'Enhanced install config files with new fields, improved Terraform and Helm plan rendering in approvals, and quality-of-life fixes across the install lifecycle.'
boost: 0.4
---
