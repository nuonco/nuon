...
description: 'Trigger drift scans directly from component and sandbox pages, view break-glass info on action pages, plus log stream and TOML parsing bug fixes.'
boost: 0.4
---
