...
description: Drift scanning improvements — better diff output, configurable detection intervals, and clearer surfacing of drift status on the install dashboard.
boost: 0.4
---
