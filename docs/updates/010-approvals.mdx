---
title: '010 - Approvals'
description: 'Install workflows now pause for explicit approval so you can verify the Helm or Terraform plan before Nuon applies infrastructure changes to a customer install.'
boost: 0.4
---
