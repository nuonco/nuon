---
title: "Approvals on Nuon workflows"
description: "Changelog 010: Workflows now support approvals so you can review Helm and Terraform plan diffs before applying any changes to a customer's environment."
boost: 0.4
---
