---
title: '010 - Approvals'
description: 'Workflows now support approvals — pause between plan and apply steps to review the Helm or Terraform diff before changes land in customer clouds.'
boost: 0.4
---
