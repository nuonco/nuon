...
description: "Runner Management Mode for automatic runner upgrades, install input updates, and new App Variables for storing shared values across an app's installs."
boost: 0.4
---
