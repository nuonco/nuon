...
description: 'Runner management mode for choosing Nuon-managed vs. customer-managed runners, input updates, and App Variables for sharing values across all installs.'
boost: 0.4
---
