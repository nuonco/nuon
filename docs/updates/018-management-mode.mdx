---
title: "Runner management mode and app variables"
description: "Changelog 018: Runner management mode for controlling runner upgrades, input updates on existing installs, and app variables for sharing values."
boost: 0.4
---
