...
description: "Nuon ships Runner Management Mode, install input updates from the dashboard, and App Variables for storing values shared across all installs."
boost: 0.4
---
