...
description: "Nuon ships runner management mode, install input updates without redeploys, and app variables for storing values shared across every install of an app."
boost: 0.4
---
