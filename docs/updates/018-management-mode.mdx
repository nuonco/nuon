...
description: 'September 8, 2025 release: runner management mode for safer upgrades, improvements to install inputs, and App Variables for storing values across all installs.'
boost: 0.4
---
