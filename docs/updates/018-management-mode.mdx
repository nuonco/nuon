...
description: "Runner Management Mode, input handling updates, and App Variables for storing values shared across installs — new features in this Nuon release."
boost: 0.4
---
