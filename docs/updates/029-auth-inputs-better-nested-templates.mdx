...
description: 'BYO-VPC support for reusing existing networks, the new Nuon Auth service, runner authentication via OIDC, and a wave of dashboard UX improvements.'
boost: 0.4
---
