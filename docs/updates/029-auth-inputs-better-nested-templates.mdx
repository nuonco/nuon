---
title: "BYO-VPC, auth, and UX improvements"
description: "Changelog 029: BYO-VPC support for installs, the new Nuon Auth service, runner authentication updates, and a batch of dashboard UX improvements."
boost: 0.4
---
