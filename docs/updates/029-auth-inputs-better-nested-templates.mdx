...
description: 'February 3, 2026 release: BYO-VPC for sandboxes, the Nuon Auth service, runner authentication via workload identity, and UX improvements in the dashboard.'
boost: 0.4
---
