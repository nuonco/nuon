...
description: "Nuon now automatically detects infrastructure drift on your installations and surfaces changes that diverge from the expected app configuration."
boost: 0.4
---
