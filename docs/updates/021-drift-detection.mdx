---
title: "Drift detection for components and sandboxes"
description: "Changelog 021: Automatically detect infrastructure drift on Nuon installs for both components and sandboxes, with scheduled scans and dashboard alerts."
boost: 0.4
---
