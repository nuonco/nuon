...
description: "Nuon now detects infrastructure drift automatically on customer installs, flagging changes in the dashboard and triggering remediation workflows."
boost: 0.4
---
