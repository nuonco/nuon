...
description: Automatic drift detection for components and sandboxes runs in the background and surfaces any out-of-band changes made to install infrastructure.
boost: 0.4
---
