...
description: "May 2026 release notes: provision Nuon AWS install stacks using Terraform — the same resources as the CloudFormation stack, your customer's choice."
boost: 0.3
---
