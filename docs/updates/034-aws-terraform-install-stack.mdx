...
description: 'May 4, 2026 release: provision the Nuon install stack on AWS using Terraform instead of CloudFormation — useful for Terraform-first customer organizations.'
boost: 0.3
---
