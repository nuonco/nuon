...
description: 'Self-service Nuon Cloud signup — anyone can register for a trial org at app.nuon.co without an invite, pick a sample app, and create their first install.'
boost: 0.4
---
