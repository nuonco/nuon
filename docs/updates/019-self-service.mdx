...
description: "Anyone can now sign up for Nuon Cloud directly, with self-service onboarding, demo apps, and instant access to launching your first BYOC install."
boost: 0.4
---
