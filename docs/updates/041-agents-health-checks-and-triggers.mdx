---
title: 041 - Using Nuon with your Agent, Health Checks, and Triggers
...
Make installing and upgrading your app an ordinary pull request in the Terraform pipeline your
customer's platform team already reviews.
...
pull request itself. Plan only — it never touches an install. See [App branches](/guides/app-branches).
