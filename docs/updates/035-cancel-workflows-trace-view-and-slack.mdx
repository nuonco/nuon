...
description: 'New: Cancel active workflows, trace timeline view, drift notifications, Slack app, component dependency graph, sandbox auto-retries. Improved: policy reports, app branches, live updates over SSE. Fixed: auto-approval, CLI, action run cancel.'
boost: 0.3
---
