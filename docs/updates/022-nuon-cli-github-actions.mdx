...
description: "New nuonco/setup-nuon-cli GitHub Action installs and authenticates the nuon CLI inside CI workflows for automated app syncs and component builds."
boost: 0.4
---
