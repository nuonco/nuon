...
description: 'October 17, 2025 release: an official GitHub Action for installing and authenticating the Nuon CLI in CI/CD workflows for automated app sync and deploys.'
boost: 0.4
---
