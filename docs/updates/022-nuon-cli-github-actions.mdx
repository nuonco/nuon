---
title: "Nuon CLI GitHub Action for CI/CD"
description: "Changelog 022: Official GitHub Action for setting up the Nuon CLI in your CI/CD workflows, with caching, version pinning, and authentication support."
boost: 0.4
---
