...
description: "The new setup-nuon GitHub Action installs the Nuon CLI in CI/CD workflows for automated app sync and release pipelines — plus other release fixes."
boost: 0.4
---
