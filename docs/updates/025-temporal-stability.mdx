...
description: "November 2025 release notes: fixes for Temporal workflows retrying on undeployed installs, plus null pointer bug fixes in inputs and components."
boost: 0.4
---
