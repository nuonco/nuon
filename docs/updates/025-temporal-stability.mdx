...
description: 'November 10, 2025 release: a set of Temporal workflow stability fixes that resolve issues with component workflows retrying unnecessarily during deploys.'
boost: 0.4
---
