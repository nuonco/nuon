...
description: Major Temporal workflow stability improvements — fixes for component workflows retrying incorrectly and more reliable long-running deploy operations.
boost: 0.4
---
