...
description: "Approval diffs for Helm teardowns, a new plan-only workflow mode, on-demand manual secret sync, and pagination flags for nuon CLI list commands."
boost: 0.4
---
_July 15th, 2025_
