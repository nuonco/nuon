...
description: 'Helm teardown diffs in approval views, a plan-only workflow mode for safe dry runs, manual secret sync triggers, and new CLI pagination flags for large orgs.'
boost: 0.4
---
_July 15th, 2025_
