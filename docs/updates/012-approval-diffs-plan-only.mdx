...
description: "Nuon ships Helm teardown diffs, plan-only workflow mode, manual secret sync triggers, and pagination flags across the CLI for install management."
boost: 0.4
---
_July 15th, 2025_
