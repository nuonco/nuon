...
description: 'July 15, 2025 release: Helm teardown diffs, plan-only workflow mode, manual secret sync from the dashboard, and new pagination flags in the Nuon CLI.'
boost: 0.4
---
_July 15th, 2025_
