---
title: "Approval diffs and plan-only workflows"
description: "Changelog 012: Helm teardown diffs, plan-only workflow mode, manual secret syncing, and new CLI pagination flags for listing apps, installs, and runs."
boost: 0.4
---
_July 15th, 2025_
