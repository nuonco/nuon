...
description: 'August 7, 2025 release: manage installs from source control with install config files — version per-install settings in Git instead of the dashboard.'
boost: 0.4
---
