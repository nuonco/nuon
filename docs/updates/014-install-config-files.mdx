...
description: Install config files let you define installs as TOML in source control and sync them with the CLI for fully GitOps-style install management.
boost: 0.4
---
