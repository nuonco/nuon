---
title: "Manage installs from install config files"
description: "Changelog 014: Manage installs declaratively via install config files in source control, including inputs, secrets, and per-install overrides."
boost: 0.4
---
