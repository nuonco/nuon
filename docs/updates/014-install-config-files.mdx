...
description: 'Manage installs via source control — define one TOML config per install under installs/, sync with nuon apps sync, and version inputs alongside app config.'
boost: 0.4
---
