...
description: "Manage Nuon installs declaratively via source control with install config files — sync install.toml from a Git repo and other release improvements."
boost: 0.4
---
