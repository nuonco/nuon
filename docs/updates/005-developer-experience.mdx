---
title: "nuon dev and developer experience updates"
description: "Changelog 005: Adds the nuon dev local development workflow, plus a batch of CLI and dashboard improvements focused on the day-to-day app authoring loop."
boost: 0.4
---
