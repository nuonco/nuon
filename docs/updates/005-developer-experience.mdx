...
description: "Nuon dev mode lets you iterate on configs with a single command, view live install state, browse the app dependency graph, and more from the CLI."
boost: 0.4
---
