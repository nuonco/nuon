...
description: 'New nuon dev CLI command — iterate on app config and deploy a dev install in a single command, view install state, and inspect the app dependency graph.'
boost: 0.4
---
