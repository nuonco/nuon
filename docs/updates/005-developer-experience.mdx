...
description: "The new nuon dev command lets you iterate on app configs with a single command, inspect install state, view app dependency graphs, and more from the CLI."
boost: 0.4
---
