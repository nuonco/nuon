...
description: "May 2025 release notes: nuon dev CLI for iterating on apps with one command, install state inspection, and app dependency graph visualization."
boost: 0.4
---
