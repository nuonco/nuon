...
description: 'May 14, 2025 release: nuon dev for fast config iteration, install state inspection, app dependency graph, and a batch of developer experience improvements.'
boost: 0.4
---
