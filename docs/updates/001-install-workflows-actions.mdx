...
description: 'Detailed step views, workflow cancellation, action output improvements, and Terraform workspace management arrive in the install workflows update.'
boost: 0.4
---
_May 5th, 2025_
