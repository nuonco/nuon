...
description: Improvements to install workflows including new step states, broader actions support across components, and assorted dashboard and CLI bug fixes.
boost: 0.4
---
_May 5th, 2025_
