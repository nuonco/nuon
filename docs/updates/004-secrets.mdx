...
description: Customer secrets now sync automatically into Kubernetes clusters running inside an install, so components can consume them via standard Secret resources.
boost: 0.4
---
_May 10th, 2025_
