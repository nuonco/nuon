...
description: "Changelog 004: Adds automatic syncing of customer secrets into Kubernetes secrets, including configuration of namespace, key mapping, and rotation."
boost: 0.4
---
_May 10th, 2025_
