...
description: "Nuon now automatically syncs customer secrets into Kubernetes clusters, plus other improvements to managing sensitive values across installs."
boost: 0.4
---
_May 10th, 2025_
