...
description: 'Customer-supplied secrets can now sync automatically into Kubernetes Secrets, plus auto-generated secret values defined in your app secrets.toml config.'
boost: 0.4
---
_May 10th, 2025_
