...
description: "Automatically sync customer-supplied secrets from Nuon into Kubernetes Secret resources inside the customer cluster — plus other release fixes."
boost: 0.4
---
_May 10th, 2025_
