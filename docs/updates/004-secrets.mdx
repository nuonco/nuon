...
description: 'May 10, 2025 release: automatically sync app secrets from the customer''s cloud secrets manager into Kubernetes secrets for Helm and manifest components.'
boost: 0.4
---
_May 10th, 2025_
