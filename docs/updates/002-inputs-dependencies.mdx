...
![UI view of resources managed by a Terraform component](/updates/assets/terraform-component-workspace.png)
...
![Export button for downloading Terraform backend configuration](/updates/assets/terraform-backend-file-export.png)
