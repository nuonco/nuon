...
Dependencies are now auto configured, based on the variables that you define. For example the following config would 
mark `container_image` as a dependency.
...
![Terraform Component Workspace](assets/terraform-component-workspace.png)
...
![Terraform Backend File Export](assets/terraform-backend-file-export.png)
