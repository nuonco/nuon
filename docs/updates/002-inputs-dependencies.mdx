...
description: 'Install inputs gain typed fields, internal flags, and auto-configured dependencies; Terraform components add KUBECONFIG integration and workspace management.'
boost: 0.4
---
_May 6th, 2025_
