...
description: "Nuon adds install inputs for per-customer configuration and component dependencies so you can model your app as an ordered graph of resources."
boost: 0.4
---
_May 6th, 2025_
