---
title: "Stack tab, VCS import, and component builds"
description: "Changelog 008: New stack management tab, importing existing VCS connections, and improvements to the component build system across all component types."
boost: 0.4
---
