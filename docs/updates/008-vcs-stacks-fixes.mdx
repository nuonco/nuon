...
description: 'New Stacks tab in the dashboard, VCS connection import flow for existing GitHub apps, and an overhauled component build system with better caching.'
boost: 0.4
---
