...
description: 'New Stack tab in the dashboard for managing install stacks, VCS connection importing for existing repos, and an improved component build system across runners.'
boost: 0.4
---
