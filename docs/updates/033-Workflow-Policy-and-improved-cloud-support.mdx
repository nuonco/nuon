---
title: '033 - Parallel Workflows, Policy Analytics, GCP & Azure'
description: 'Parallel workflows, automatic retries, policy analytics, and labels arrive in Nuon, alongside major Azure, GCP, plan diff, and runner management upgrades.'
boost: 0.3
---
