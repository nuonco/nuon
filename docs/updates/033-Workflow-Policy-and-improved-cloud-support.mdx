...
description: 'April 24, 2026 release: parallel workflows, workflow retries, policy analytics, labels, and improved Azure, GCP, plan diffs, and runner management mode.'
boost: 0.3
---
