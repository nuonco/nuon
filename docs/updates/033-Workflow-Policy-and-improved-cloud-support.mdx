---
title: '033 - Parallel Workflows, Policy Analytics, Cloud Support'
description: 'Parallel workflows with retries, policy analytics, install labels, and improvements to Azure and GCP support, plan diffs, and runner management.'
boost: 0.3
---
