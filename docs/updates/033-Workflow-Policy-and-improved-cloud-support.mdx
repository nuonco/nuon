---
title: '033 - Parallel workflows, policy analytics, GCP and Azure'
description: 'Parallel workflows, retries, policy analytics, and labels arrive alongside improvements to Azure, GCP, plan diffs, and runner management in Nuon.'
boost: 0.3
---
