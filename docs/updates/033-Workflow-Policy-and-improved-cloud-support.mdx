...
description: 'Parallel workflows, automatic component retries, policy analytics, labels for installs, and improved Azure, GCP, plan diffs, and runner management.'
boost: 0.3
---
