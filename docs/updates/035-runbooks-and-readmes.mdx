...
Both default to off and can be set on a [Helm](/config-ref/helm), [Terraform](/config-ref/terraform), Docker build, or [Kubernetes manifest](/config-ref/kubernetes-manifest) component, or on the [sandbox](/config-ref/sandbox).
