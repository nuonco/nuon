...
description: "New kubernetes_manifest component type — deploy raw Kubernetes YAML resources directly into customer clusters without packaging them as a Helm chart."
boost: 0.4
---
_August 1st, 2025_
