...
description: "Nuon introduces the kubernetes-manifest component type for deploying raw Kubernetes resources — Deployments, Services, CRDs — into customer clusters."
boost: 0.4
---
_August 1st, 2025_
