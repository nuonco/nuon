...
![Kubernetes Manifest Component Support](/updates/assets/013-kubernetes-component-config.png)

![Kubernetes Manifest Approvals and Diffs](/updates/assets/013-kubernetes-component-approvals.png)

## Support Helm Resource Diffs

Previously, we did not support showing Helm resource-level diffs.

![Helm Changes Overview](/updates/assets/013-helm-resource-diffs.png)
...
![Improved Support for Larger Plans](/updates/assets/013-improved-larger-plans.png)
