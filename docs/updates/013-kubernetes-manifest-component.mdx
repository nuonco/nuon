...
description: 'New Kubernetes Manifest component type for deploying raw Kubernetes resources directly into customer cloud accounts without packaging them in a Helm chart.'
boost: 0.4
---
_August 1st, 2025_
