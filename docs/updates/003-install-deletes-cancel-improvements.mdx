...
description: 'Improvements to install deletion and workflow cancellation — component dependency sub-ordering, deprovision options, and UI enhancements across the dashboard.'
boost: 0.4
---
_May 8th, 2025_
