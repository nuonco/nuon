...
- **Install Config Sync**: Install will be put into "mangaed-by-config" mode, even if there are no changes to sync.
- **Install Config Generation**: Install configs will generate even if inputs are empty.
...
- **Trial Org Support Users**: Support users are now added to trial orgs, to provide support for new users.
