...
description: "Release notes — clearer install config mode switching, plus a batch of dashboard and CLI improvements and stability fixes across the Nuon platform."
boost: 0.4
---
