...
description: 'Toggle install config file syncing on or off per install from the dashboard or with the new nuon installs toggle-sync CLI command for clearer mode switching.'
boost: 0.4
---
