---
title: "Install config mode toggle"
description: "Changelog 027: Clearer install config mode switching between dashboard-managed and file-managed installs, with explicit migration prompts in the UI."
boost: 0.4
---
