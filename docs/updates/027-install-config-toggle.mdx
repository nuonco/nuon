...
description: A new dashboard toggle makes it explicit when an install is managed by install config files versus dashboard inputs, with clearer mode transitions.
boost: 0.4
---
