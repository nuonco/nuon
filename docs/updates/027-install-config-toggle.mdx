...
description: 'November 20, 2025 release: clearer toggle between dashboard-managed and config-file-managed install configuration, with safer transitions between the two modes.'
boost: 0.4
---
