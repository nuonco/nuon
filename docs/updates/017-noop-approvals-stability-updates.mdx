...
description: 'Workflow approvals with no infrastructure changes are now auto-approved, install config file ergonomics improve, and several runner stability fixes ship.'
boost: 0.4
---
August 28th, 2025
