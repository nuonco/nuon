...
description: No-op approvals now auto-approve when plans show no changes, plus install config file improvements and a batch of stability fixes across the platform.
boost: 0.4
---
August 28th, 2025
