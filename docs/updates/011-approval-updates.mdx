---
title: "Approval improvements and UI updates"
description: "Changelog 011: Inline workflow retries, auto-approve-all steps, dashboard UI renames, and team member removal across the Nuon control plane and CLI."
boost: 0.4
---
