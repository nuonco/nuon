...
description: 'Inline workflow retries, an auto-approve-all-steps mode, dashboard renames for clarity, and the ability to remove team members from your Nuon org.'
boost: 0.4
---
