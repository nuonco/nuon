...
description: "Approval improvements — inline workflow retries, auto-approve all steps, dashboard UI renames for clarity, and the ability to remove team members."
boost: 0.4
---
