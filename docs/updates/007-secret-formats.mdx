...
description: "Nuon adds support for additional secret formats and ships bug fixes for secret rendering, sync, and CloudFormation parameter mapping on installs."
boost: 0.4
---
