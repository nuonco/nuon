---
title: "Secret formats and bug fixes"
description: "Changelog 007: Adds support for typed secret formats — JSON, key-value, certificate — plus a round of bug fixes across the Nuon platform."
boost: 0.4
---
