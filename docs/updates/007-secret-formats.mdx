...
description: "Release notes — new secret formats for app secrets, plus a batch of bug fixes and platform improvements across the Nuon control plane and CLI."
boost: 0.4
---
