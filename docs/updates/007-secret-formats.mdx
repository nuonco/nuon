...
description: 'Declare a format like base64 on secrets so Nuon decodes values automatically when syncing them into Kubernetes — plus assorted bug fixes across the platform.'
boost: 0.4
---
