...
description: 'New secret format options for structured and multi-line values, more reliable secret sync, and bug fixes across the CLI, dashboard, and runners.'
boost: 0.4
---
