...
description: 'Deploy Helm charts directly from public Helm repositories as Nuon components — no need to vendor charts into your app repo or build OCI artifacts first.'
boost: 0.4
---
