...
description: 'November 12, 2025 release: Helm chart components can now pull directly from public Helm repositories — no need to vendor charts into your app''s connected repo.'
boost: 0.4
---
