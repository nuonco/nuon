...
description: Helm chart components can now pull directly from public Helm chart repositories, no Git checkout required, for faster setup of upstream charts.
boost: 0.4
---
