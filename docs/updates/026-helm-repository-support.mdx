---
title: "Helm repository support for components"
description: "Changelog 026: Deploy Helm charts directly from public Helm repositories — no need to vendor the chart into your repo before using it as a component."
boost: 0.4
---
