---
title: "Operation roles for least-privilege installs"
description: "Changelog 031: Adds operation roles so you can assign different IAM roles to sandbox, component, and action operations for least-privilege installs."
boost: 0.4
---
