...
description: 'Operation Roles — assign different IAM roles per sandbox, component, and action operation for least-privilege access control across customer installs.'
boost: 0.4
---
