...
description: 'Assign distinct IAM roles to provision, deploy, maintain, and deprovision operations across sandboxes, components, and actions for least-privilege workflows.'
boost: 0.4
---
