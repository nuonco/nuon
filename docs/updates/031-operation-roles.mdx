...
description: 'February 26, 2026 release: operation roles let you assign different IAM roles to sandbox runs, component deploys, and actions for least-privilege BYOC access.'
boost: 0.4
---
