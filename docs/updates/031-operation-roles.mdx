...
description: "Operation roles arrive in Nuon: assign distinct IAM roles to sandbox, component, and action operations to enforce least-privilege access on installs."
boost: 0.4
---
