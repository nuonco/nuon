...
description: "Release notes — assign different IAM roles to different operations across sandboxes, components, and actions for least-privilege access control."
boost: 0.4
---
