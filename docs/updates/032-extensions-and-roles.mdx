---
title: '032 - TUIs, Extensions, and Role Management'
description: "Nuon ships CLI workflow TUIs, CLI Extensions to GA, dashboard workflow and onboarding upgrades, and expanded operation role support in the API."
boost: 0.3
---
