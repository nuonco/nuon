---
title: '032 - Workflow TUI, CLI Extensions, and Role Updates'
description: 'CLI workflow TUI goes GA, CLI Extensions ship as first-class commands, dashboard onboarding improves, and operation role support expands in the API.'
boost: 0.3
---
