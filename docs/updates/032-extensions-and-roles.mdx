---
title: '032 - CLI TUIs, Extensions GA, and Role Management'
description: "CLI workflow TUIs, CLI Extensions to GA, dashboard workflow and onboarding improvements, and expanded operation role support across the platform."
boost: 0.3
---
