---
title: '032 - CLI TUIs, Extensions GA, and operation roles'
description: "CLI workflow TUIs, CLI Extensions reaching GA, dashboard workflow and onboarding improvements, and expanded operation role support across the Nuon platform."
boost: 0.3
---
