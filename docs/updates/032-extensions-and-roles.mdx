...
description: "Nuon ships interactive CLI workflow TUIs, promotes CLI Extensions to GA, refreshes the dashboard onboarding, and expands operation role support."
boost: 0.3
---
