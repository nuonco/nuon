...
Nuon apps using ECS offer a simpler way to integrate with existing non-Kubernetes applications, without changing your
product architecture.

Creating a Nuon app that uses ECS is as simple as configuring an ECS runner, and selecting an ECS sandbox. You can
configure an ECS runner using Terraform:
