...
even provided by customers (by creating a [custom sandbox](/guides/sandboxes#create-a-custom-sandbox).
...
Nuon deploys a [runner](/guides/runners) into each install to manage it. The runner is responsible for the
following:
