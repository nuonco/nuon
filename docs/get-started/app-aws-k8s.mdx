...
description: "Package and deploy a Helm app onto AWS EKS in your own cloud account."
---

**What you'll build:**

- An [App](/concepts/apps)
- A [`whoami` Helm component](/concepts/components)
- An [Install](/guides/app-install-life-cycle) running on the [AWS EKS sandbox](/concepts/sandboxes#nuon-managed-sandboxes)
