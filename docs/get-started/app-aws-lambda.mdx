...
description: "Walk through packaging and installing an AWS Lambda app with Nuon, from configuration files to provisioning the customer-hosted runner and Lambda resources."
---
<Note>
