...
This guide walks you through packaging an AWS EKS Traefik `whomani` application and deploying it to an Install.
...
Click or copy the CloudFormation link to open it in your AWS account. You will need to log in to your AWS account if you are not already logged in. This creates a VM and installs the Nuon Runner in your AWS account, which will be used to provision the install.
