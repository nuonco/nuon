---
title: 'Quickstart'
description: "Get up and running with Nuon in a few minutes: install the CLI, sign in to Nuon Cloud, create your first app, and deploy a sample install into AWS."
boost: 5
