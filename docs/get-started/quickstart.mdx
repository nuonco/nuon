---
title: 'Quickstart'
description: "Get up and running with Nuon in a few minutes: install the CLI, authenticate, pick a demo app, and launch your first BYOC install into AWS, Azure, or GCP."
boost: 5
