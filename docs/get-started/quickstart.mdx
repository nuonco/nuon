---
title: 'Quickstart'
description: 'Get up and running with Nuon in minutes — install the CLI, create an org, define an app, configure a runner and sandbox, and deploy your first install.'
boost: 5
