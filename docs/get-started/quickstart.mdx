---
title: 'Quickstart'
description: "Install the CLI, authenticate, and get ready to deploy your first install."
---

**What you'll do:** install the Nuon CLI, authenticate against your org, and connect your GitHub account so it can deploy code from your repos.

**What you'll need:**

- A Nuon org (free trial sign-up [here](https://app.nuon.co/))
- A terminal with Homebrew available, or `curl` for the install script
- A GitHub account if you plan to deploy from private repositories
...
**Next:** [Create your first install →](/get-started/create-your-first-app)
