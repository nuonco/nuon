...
installs. `eks-simple` already ships its branch config — nothing needs writing. This walkthrough syncs it into your
org and takes a change through it end to end: preview the diff, plan each deployment group, approve, deploy.
