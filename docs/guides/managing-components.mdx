...
description: "List, build, redeploy, and inspect Nuon components from the CLI, including viewing component builds, plans, deploy logs, and version history per install."
icon: "terminal"
---
