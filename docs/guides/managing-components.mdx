...
description: "List, build, redeploy, and manage Nuon components using the CLI, including triggering rebuilds, inspecting build logs, and rolling out new versions."
icon: "terminal"
---
