...
description: 'List components, trigger builds, view build logs, and manage component configuration across versions and installs using the Nuon CLI and dashboard.'
icon: "terminal"
---
