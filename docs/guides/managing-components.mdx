...
description: "List components for an app, trigger new builds, inspect build logs, and manage component config with the nuon CLI to operate components day-to-day."
icon: "terminal"
---
