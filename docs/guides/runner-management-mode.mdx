...
description: "Configure runner management mode for new Nuon installs or migrate existing installs to a fully managed agent rollout, upgrade, and lifecycle model."
icon: "server"
