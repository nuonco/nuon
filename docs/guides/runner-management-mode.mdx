...
description: "Enable Nuon runner management mode for new installs or migrate existing installs to the standalone management process for safer runner upgrades."
icon: "server"
