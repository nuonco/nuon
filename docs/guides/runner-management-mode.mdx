...
description: "Configure runner management mode when creating new installs or migrate existing installs between modes to control how Nuon manages runner upgrades."
icon: "server"
