...
description: "Configure Nuon's runner management mode for new installs and migrate existing installs to managed runners with automatic upgrades and lifecycle handling."
icon: "server"
