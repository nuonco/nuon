---
title: Using READMEs
description: 'Render Markdown READMEs per Nuon install — embed install-specific values and instructions into docs that customers and operators can read from the dashboard.'
icon: "file-lines"
