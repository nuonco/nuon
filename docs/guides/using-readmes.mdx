---
title: Using READMEs
description: "Use install READMEs to document operating procedures, surface install metadata, and give customers contextual guidance inside the Nuon dashboard."
icon: "file-lines"
