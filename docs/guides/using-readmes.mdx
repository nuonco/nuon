---
title: Using READMEs
description: Attach per-install README templates rendered with Nuon's templating engine so operators see customer-specific runbooks and operating instructions.
icon: "file-lines"
