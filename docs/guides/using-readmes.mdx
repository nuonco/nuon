---
title: Using READMEs
description: "Use READMEs on Nuon apps, components, and installs to give operators and customers contextual, install-specific runbooks rendered in the dashboard."
icon: "file-lines"
