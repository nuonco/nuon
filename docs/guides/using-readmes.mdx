---
title: Using READMEs
description: 'Write README.md files in your app config and Nuon renders them on every install page — surface runbooks, contact info, and post-install steps to customers.'
icon: "file-lines"
