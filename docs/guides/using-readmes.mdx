...
For a runnable example — a per-install app README and runbook READMEs that render
live values and embed runnable runbooks — see the
[`programmable-runbook-and-readme`](https://github.com/nuonco/example-app-configs/tree/main/programmable-runbook-and-readme)
app config in `example-app-configs`.
