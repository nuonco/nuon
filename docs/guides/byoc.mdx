...
Nuon BYOC allows you to run Nuon in your own AWS account instead of using Nuon's managed infrastructure. This gives you full control over your data, networking, and compliance requirements.

<Note>
For the time being, this process is best done on a call with the Nuon team. Nuon has a complex architecture, and we're still ironing out some of the rough edges in the setup process.
</Note>
...
- A GitHub account in which you can create a GitHub App to grant access to private repos
- An Auth0 tenant for auth (we have plans to remove this requirement in the future)
- Access to the Nuon dashboard

## Getting Your Install ID

<Note>
This step should be completed by the Nuon team.
</Note>
