...
icon: "cloud-arrow-up"
keywords: ["Nuon BYOC", "self-hosted Nuon", "install Nuon", "AWS deployment", "Azure deployment", "GCP deployment", "Nuon setup", "BYOC installation"]
---
...
- [AWS](/guides/byoc/aws) — Primary supported platform. Nuon deploys on EKS with RDS, ECR, Route 53, ACM, and Secrets Manager.
