...
<Frame caption="Nuon Cloud manages your BYOC control plane as an install. Your control plane then manages your customers' installs the same way.">
  <img src="/images/guides/byoc/byoc-overview.png" alt="Three stacked layers: Nuon Cloud at the top; your cloud account in the middle, containing a BYOC Runner and your Nuon instance; and your customers' clouds at the bottom, containing an Install Runner and Installs. The BYOC Runner polls Nuon Cloud for jobs and installs and updates your Nuon instance. The Install Runner polls your Nuon instance for jobs, pulls artifacts, and deploys installs." />
</Frame>
