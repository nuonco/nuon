...
To use Auth0 for authetnication, you will need to configure an API, applications, and a custom action in your Auth0 tenant.
...
<Warning>
If using the deprecated Auth0 integration, you will need to provide these inputs intead.
