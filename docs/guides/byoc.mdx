...
description: "Set up Nuon BYOC to install and manage Nuon itself inside your own AWS, Azure, or GCP account using the BYOC installer and managed control plane."
icon: "cloud-arrow-up"
