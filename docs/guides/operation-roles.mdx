...
description: "Assign distinct IAM roles to different operations across the sandbox, components, and actions in your Nuon app for least-privilege BYOC deployments."
icon: "user-lock"
