...
description: "Assign different IAM roles to different operations across sandbox provisioning, component deploys, and actions for least-privilege access control."
icon: "user-lock"
