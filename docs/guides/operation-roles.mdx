---
title: 'Configure operation roles'
description: 'Assign distinct IAM roles to provision, deploy, maintain, and deprovision operations across sandboxes, components, and actions in your Nuon app config.'
icon: "user-lock"
