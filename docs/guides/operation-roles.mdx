...
description: 'Use operation_roles.toml to assign different IAM roles to each Nuon operation — sandbox, components, and actions — for fine-grained, least-privilege access.'
icon: "user-lock"
