...
description: "Configure operation_roles in your app TOML to assign separate IAM roles per sandbox, component, and action operation for least-privilege Nuon deploys."
icon: "user-lock"
