...
description: "Assign different IAM roles to different operations — sandbox, components, actions — to enforce least-privilege access for every customer install."
icon: "user-lock"
