---
title: "Configure operation roles in your app"
description: "Assign different IAM roles to different install operations — sandbox, components, actions — so each step runs with only the permissions it needs."
icon: "user-lock"
