...
icon: "layer-group"
boost: 10
keywords: ["spacelift", "install-stacks", "terraform", "blueprint", "install stack", "stacks", "gcp", "google cloud", "raw git", "spacelift blueprint", "spacelift terraform provider"]
---

<Note>Spacelift support for install stacks is available for Google Cloud installs and is gated behind a feature flag. [Reach out to Nuon](https://nuon.co/demo-request) to enable it for your org.</Note>
