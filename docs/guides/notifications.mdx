---
title: 'Notifications'
description: "Send Slack webhook notifications for app and install lifecycle events to keep your team informed about deploys, drift, and approval requests."
icon: "bell"
