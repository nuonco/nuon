---
title: 'Notifications'
description: "Send Slack webhook notifications for Nuon app and install lifecycle events, including workflow starts, approvals, failures, and successful component deploys."
icon: "bell"
