---
title: 'Notifications'
description: "Send Slack webhook notifications for app and install lifecycle events from Nuon, including provisioning, deploys, action runs, and policy failures."
icon: "bell"
