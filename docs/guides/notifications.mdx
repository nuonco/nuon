---
title: 'Notifications'
description: "Send Slack webhook notifications for Nuon app and install lifecycle events — wire up your channel to get alerts on deploys, drift, and failures."
icon: "bell"
