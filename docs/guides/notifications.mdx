---
title: 'Notifications'
description: "Configure Slack webhook notifications so your team gets alerts for app builds, install workflows, deploy failures, and other Nuon lifecycle events."
icon: "bell"
