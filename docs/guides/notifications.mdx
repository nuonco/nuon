---
title: 'Notifications'
description: 'Send Slack webhook notifications for Nuon app and install lifecycle events — deploys, approvals, drift, action runs, and workflow successes or failures.'
icon: "bell"
