---
title: 'Notifications'
description: 'Configure Slack webhook notifications for app and install lifecycle events — workflows, actions, drift, approvals — at the Nuon Org or per-app level.'
icon: "bell"
