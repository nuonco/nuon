...
description: 'Configure the base Terraform sandbox for your Nuon app — sandbox source, variables, terraform version, drift schedule, and connected-repo or Git sources.'
icon: "gear"
boost: 7
