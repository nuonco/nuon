...
description: "Configure the sandbox Terraform workspace Nuon provisions per install, including variables, env vars, drift schedule, and VCS source for custom templates."
icon: "gear"
boost: 7
