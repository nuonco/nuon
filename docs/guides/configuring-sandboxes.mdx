...
description: "Configure the sandbox.toml block to provision per-customer base infrastructure — VPCs, Kubernetes clusters, IAM roles — for each install of your app."
icon: "gear"
boost: 7
