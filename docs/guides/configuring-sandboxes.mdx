...
description: "Configure your Nuon sandbox.toml to provision the base infrastructure each install needs — VPCs, clusters, region settings, and Terraform variables."
icon: "gear"
boost: 7
