...
description: "Configure the Terraform sandbox that provisions per-install base infrastructure in customer cloud accounts: region, variables, drift schedule, and roles."
icon: "gear"
boost: 7
