...
description: 'Connect your GitHub account to Nuon to use public and private repositories as component sources, action scripts, and Terraform module locations.'
icon: "code-branch"
