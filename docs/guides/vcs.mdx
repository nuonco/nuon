---
title: 'Connect GitHub to Nuon'
description: 'Install the Nuon GitHub App to use public and private repositories as sources for sandboxes, components, Helm charts, and Docker builds in your Nuon apps.'
icon: "code-branch"
