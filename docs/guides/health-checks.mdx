...
<Steps>
  <Step title="Ask Nuon to enable it">
    Health checks are behind the `component-health` org feature. Ask us to switch them on for your
...
<AccordionGroup>
  <Accordion title="Everything shows unknown or no resources at all">
    ...
    health checks were enabled. Click **Refresh cluster access** on the install's health card, or
