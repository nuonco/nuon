...
description: 'Compare Nuon Cloud, Nuon BYOC, and Self-Hosted Nuon — choose where Nuon''s control plane runs while still deploying your apps into customer AWS, Azure, or GCP.'
icon: 'cloud-arrow-up'
