...
description: "Compare the ways to run Nuon — managed Nuon Cloud, BYOC into your own cloud, and fully self-hosted — and choose the right deployment model for your team."
icon: 'cloud-arrow-up'
