...
description: 'Install community and first-party plugins to extend the nuon CLI with new commands like policies, custom workflows, and team-specific tooling.'
icon: 'puzzle-piece'
