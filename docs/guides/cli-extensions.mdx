...
description: 'Extend the Nuon CLI with first-party and community plugins — add subcommands for policies, workflow TUIs, and other custom tooling on top of the nuon binary.'
icon: 'puzzle-piece'
