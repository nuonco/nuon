...
description: "Extend the Nuon CLI with first-party and community plugins to add new commands, workflows, and integrations on top of the standard nuon binary."
icon: 'puzzle-piece'
