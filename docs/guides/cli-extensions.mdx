...
description: "Extend the Nuon CLI with community and first-party plugins to add new commands, integrate with internal tools, and customize day-2 operator workflows."
icon: 'puzzle-piece'
