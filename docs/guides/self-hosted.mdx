...
description: 'Run a fully self-hosted Nuon Control Plane in air-gapped or sovereign environments with no inbound or outbound path back to Nuon-managed infrastructure.'
icon: 'server'
