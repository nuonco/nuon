...
description: "Run Nuon entirely within your own infrastructure with no path for Nuon to reach in, ideal for regulated environments and air-gapped deployments."
icon: 'server'
