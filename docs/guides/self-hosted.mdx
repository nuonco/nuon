...
description: 'Run Self-Hosted Nuon entirely within your own AWS, Azure, or GCP infrastructure with no inbound path from Nuon — the most disconnected deployment option.'
icon: 'server'
