...
description: "Run Nuon entirely within your own infrastructure with no outbound path to Nuon Cloud, using the self-hosted Control Plane on AWS, Azure, or GCP."
icon: 'server'
