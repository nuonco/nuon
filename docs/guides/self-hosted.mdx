...
description: 'Run Nuon entirely within your own infrastructure with no inbound path from Nuon — self-host the control plane on AWS, Azure, or GCP for air-gapped environments.'
icon: 'server'
