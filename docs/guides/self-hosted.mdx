---
title: "Self-hosted Nuon installation guide"
description: "Run Nuon entirely within your own infrastructure with no inbound path from Nuon, suitable for air-gapped environments and strict compliance requirements."
icon: 'server'
