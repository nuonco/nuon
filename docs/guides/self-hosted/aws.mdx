...
description: 'Deploy a fully self-hosted Nuon Control Plane in your AWS account on EKS with no path back to Nuon — for air-gapped, sovereign, or regulated environments.'
icon: 'cloud-arrow-up'
