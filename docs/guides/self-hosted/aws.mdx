...
description: "Deploy the self-hosted Nuon Control Plane in your AWS account: prerequisites, infrastructure stack, secrets, DNS, certificates, and post-install steps."
icon: 'cloud-arrow-up'
