...
description: 'Deploy Self-Hosted Nuon into your own AWS account — install dependencies, run the Terraform, and operate the Nuon control plane within your own infrastructure.'
icon: 'cloud-arrow-up'
