...
description: "Deploy a self-hosted Nuon control plane in your AWS account, including prerequisites, IAM, networking, and step-by-step installation instructions."
icon: 'cloud-arrow-up'
