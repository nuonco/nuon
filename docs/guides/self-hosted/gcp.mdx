...
description: "Deploy the self-hosted Nuon Control Plane in your GCP project: prerequisites, Terraform stack, secrets, DNS, certificates, and post-install steps."
icon: 'cloud-arrow-up'
