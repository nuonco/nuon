...
description: 'Deploy a fully self-hosted Nuon Control Plane in your Google Cloud project on GKE with no path back to Nuon — for air-gapped or sovereign deployments.'
icon: 'cloud-arrow-up'
