...
description: "Deploy a self-hosted Nuon control plane in your Google Cloud project, including prerequisites, IAM setup, networking, and step-by-step installation."
icon: 'cloud-arrow-up'
