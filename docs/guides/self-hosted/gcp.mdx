...
description: 'Deploy Self-Hosted Nuon into your Google Cloud project — install dependencies, run the Terraform, and operate the Nuon control plane within your infrastructure.'
icon: 'cloud-arrow-up'
