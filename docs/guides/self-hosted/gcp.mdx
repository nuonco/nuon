...
description: 'Deploy a fully self-hosted, air-gapped Nuon control plane in your own Google Cloud project — no path for Nuon to reach in for sovereign compliance.'
icon: 'cloud-arrow-up'
