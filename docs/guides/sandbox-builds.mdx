...
A sandbox build is a record tied to one app config version and one sandbox config, executed by the
[Control Plane](/architecture/platform#builds). It moves through
