---
title: 'Nuon BYOC: GCP'
description: "Install and run Nuon BYOC in your own Google Cloud project, including prerequisites, IAM setup, and bootstrapping the Nuon control plane on GCP."
icon: 'cloud-arrow-up'
