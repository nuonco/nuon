---
title: 'Nuon BYOC: GCP'
description: 'Install and run Nuon BYOC inside your own Google Cloud project so the Nuon control plane and runners live in infrastructure you own, monitor, and audit.'
icon: 'cloud-arrow-up'
