---
title: 'Nuon BYOC: GCP'
description: 'Install Nuon BYOC into your own Google Cloud project — a single-tenant Nuon control plane backed by GKE, Cloud SQL, and Artifact Registry, managed by Nuon.'
icon: 'cloud-arrow-up'
