---
title: 'Nuon BYOC: GCP'
description: 'Install and run a managed Nuon control plane inside your Google Cloud project — service account setup, GKE cluster, Cloud SQL, and Artifact Registry.'
icon: 'cloud-arrow-up'
