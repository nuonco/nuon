---
title: 'Nuon BYOC: GCP'
description: 'Step-by-step setup for installing a Nuon BYOC Control Plane in a Google Cloud project on GKE with Cloud SQL, Artifact Registry, and Workload Identity.'
icon: 'cloud-arrow-up'
