...
4. Under **OAuth & Permissions → Redirect URLs**, add:
   ...
   ```
   https://app.<your-root-domain>/slack/oauth/callback
   ```
...
| ---------------- | -------------------------------------------------- |
| Command          | `/nuon`                                            |
| Request URL      | `https://app.<your-root-domain>/slack/commands/nuon` |
...
6. Under **Interactivity & Shortcuts**, enable interactivity and set:
   ...
   ```
   Request URL: https://app.<your-root-domain>/slack/interactions
   ```

7. Under **Event Subscriptions**, enable events and set:

   ```
   Request URL: https://app.<your-root-domain>/slack/events
   ```
...
| Slack OAuth Redirect URL  | `https://app.<your-root-domain>/slack/oauth/callback`     |
