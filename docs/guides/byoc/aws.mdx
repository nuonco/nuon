---
title: 'Nuon BYOC: AWS'
description: "Install and run Nuon BYOC in your own AWS account, including prerequisites, IAM setup, and the steps to bootstrap the Nuon control plane on AWS."
icon: 'cloud-arrow-up'
