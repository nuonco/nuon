---
title: 'Nuon BYOC: AWS'
description: 'Step-by-step setup for installing a Nuon BYOC Control Plane in your AWS account on EKS using CloudFormation, IAM roles, and AWS-native services.'
icon: 'cloud-arrow-up'
