---
title: 'Nuon BYOC: AWS'
description: 'Install and run a managed Nuon control plane inside your AWS account — CloudFormation prerequisites, EKS setup, networking, and post-install steps.'
icon: 'cloud-arrow-up'
