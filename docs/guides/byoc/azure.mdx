...
description: "Install and run Nuon BYOC in your own Azure subscription, including the BYOC ARM template, service principal, runner, and Control Plane connection."
icon: 'cloud-arrow-up'
