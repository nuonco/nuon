...
description: "Install and run Nuon BYOC in your own Azure subscription, including prerequisites, role assignments, and bootstrapping the Nuon control plane on Azure."
icon: 'cloud-arrow-up'
