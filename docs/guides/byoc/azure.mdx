...
description: 'Install and run a managed Nuon control plane inside your Azure subscription — service principal setup, AKS cluster, and post-install configuration.'
icon: 'cloud-arrow-up'
