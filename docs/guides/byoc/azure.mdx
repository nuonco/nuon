...
description: 'Step-by-step setup for installing a Nuon BYOC Control Plane in your Azure subscription using AKS, Entra ID workload identity, and Bicep templates.'
icon: 'cloud-arrow-up'
