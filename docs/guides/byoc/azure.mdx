...
description: "Install and run Nuon BYOC in your own Azure account — connect Azure, deploy the install stack, and start shipping apps to customer subscriptions."
icon: 'cloud-arrow-up'
