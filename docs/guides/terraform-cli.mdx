...
description: "Run terraform plan and apply locally against your Nuon-managed sandbox and component workspaces to debug, inspect state, and develop modules faster."
icon: "terminal"
