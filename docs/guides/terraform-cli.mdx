...
description: "Run terraform plan, apply, and state commands locally against your Nuon-managed sandbox and component workspaces for debugging and one-off changes."
icon: "terminal"
