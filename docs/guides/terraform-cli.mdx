...
description: "Run terraform plan, apply, and state commands locally against Nuon-managed sandbox and Terraform component workspaces for debugging and inspection."
icon: "terminal"
