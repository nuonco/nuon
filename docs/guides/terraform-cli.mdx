...
description: 'Run terraform init, plan, and apply locally against Nuon-managed sandbox and component workspaces — useful for debugging state and running targeted plans.'
icon: "terminal"
