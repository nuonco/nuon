...
description: "Run Terraform commands locally against your Nuon-managed sandbox and component workspaces to inspect state, plan changes, and debug provisioning issues."
icon: "terminal"
