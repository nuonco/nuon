...
description: "Run Terraform CLI commands locally against Nuon-managed sandbox and component workspaces for debugging, imports, targeted plans, and state inspection."
icon: "terminal"
