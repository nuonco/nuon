...
description: 'Run terraform CLI commands locally against your Nuon-managed sandbox and component workspaces to inspect state, run targeted plans, and debug components.'
icon: "terminal"
