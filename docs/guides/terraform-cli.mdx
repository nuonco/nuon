...
description: "Run Terraform commands locally against your Nuon-managed sandbox and component workspaces to debug, inspect state, and iterate on infrastructure."
icon: "terminal"
