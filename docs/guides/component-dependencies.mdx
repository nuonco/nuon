...
description: "Declare dependencies between Nuon components to model your app as a directed graph, control deploy order, and share outputs from one component to another."
