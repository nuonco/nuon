...
description: "Model your Nuon app as a graph by declaring dependencies between components — control deploy order and share outputs across the dependency chain."
