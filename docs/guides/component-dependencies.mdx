...
description: 'Model your Nuon app as a dependency graph — declare component dependencies so deploys, teardowns, and drift scans run in the correct topological order.'
