...
description: 'Declare dependencies between Nuon components to model your app as a DAG, control deploy order, and pass outputs from one component into another.'
