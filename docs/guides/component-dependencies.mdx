...
description: "Define explicit dependencies between Nuon components to control deploy order, model app graphs, and pass outputs from one component to another at runtime."
