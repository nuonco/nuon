...
keywords: ["reprovision", "reprovision install", "reprovision stack", "reprovision sandbox", "recreate runner", "stack-only", "AWS install", "GCP install", "Terraform stack update", "ASG recreate", "install workflow"]
---
...
<Icon icon="gear" /> **Settings**, then **Reprovision stack**. Components are never redeployed by a stack
reprovision — use a full reprovision when you also want the sandbox and components rebuilt.
