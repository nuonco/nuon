---
title: "Managing Apps"
description: "Use the nuon CLI and dashboard to create apps, sync TOML configs, manage releases, archive apps, and run the full app lifecycle across your org."
icon: "terminal"
---
