---
title: "Managing Apps"
description: 'Use the nuon CLI to create, configure, sync, and manage Nuon apps from your terminal, and use the dashboard for app-level views and lightweight edits.'
icon: "terminal"
---
