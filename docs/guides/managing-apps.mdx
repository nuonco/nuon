---
title: "Managing Apps"
description: 'Create, configure, sync, and delete Nuon apps using the CLI and dashboard — manage app metadata, branches, and configuration versions across environments.'
icon: "terminal"
---
