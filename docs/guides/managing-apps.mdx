---
title: "Managing Apps"
description: "Create, configure, sync, and delete Nuon apps using the CLI and dashboard, including config validation, branch syncing, and managing app metadata."
icon: "terminal"
---
