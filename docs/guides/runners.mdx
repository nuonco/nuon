...
outputs](./sandboxes#sandbox-outputs) to authenticate and correctly configure your runner.
...
<Note>
Technically, you can use an `aws-ecs` Fargate runner with an `aws-eks` app but is not recommended.
