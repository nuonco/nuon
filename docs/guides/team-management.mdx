...
description: "Invite, remove, and manage team members in your Nuon org, assign roles, and control who can create apps, sync configs, and approve install workflows."
icon: "users"
