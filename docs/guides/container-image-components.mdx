...
description: "Container image components let you connect prebuilt OCI images from ECR, ACR, GAR, or any registry and deploy them to customer cloud accounts."
icon: "box"
