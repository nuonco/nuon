...
description: "Use container-image components in a Nuon app to deploy prebuilt images from registries like ECR, GAR, or ACR without rebuilding them in your runner."
icon: "box"
