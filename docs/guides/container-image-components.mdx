...
description: 'Import prebuilt container images from public registries, AWS ECR, Azure ACR, or GCP Artifact Registry as Nuon components without building from a Dockerfile.'
icon: "box"
