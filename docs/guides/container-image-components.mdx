...
description: "Use container_image components to deploy prebuilt OCI images from public registries, AWS ECR, or GCP Artifact Registry into customer installs."
icon: "box"
