...
description: "Use prebuilt container images as Nuon components by pointing at ECR, ACR, GAR, or public registries, including tag pinning and external image policies."
icon: "box"
