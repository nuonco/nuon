...
[values]
"env.IMAGE_TAG"        = "{{.nuon.components.app_image.outputs.image.tag}}"
"env.IMAGE_REPOSITORY" = "{{.nuon.components.app_image.outputs.image.repository}}"
```
...
[vars]
"image_tag"        = "{{.nuon.components.app_image.outputs.image.tag}}"
"image_repository" = "{{.nuon.components.app_image.outputs.image.repository}}"
```
...
name      = "eks_job"
type      = "job"
image_url = "{{.nuon.components.app_image.outputs.image.repository}}"
tag       = "{{.nuon.components.app_image.outputs.image.tag}}"
```
