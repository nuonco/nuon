...
description: 'Bootstrap a new Nuon application with the CLI — generate metadata, sandbox, runner, and component config files with a single nuon apps init command.'
icon: 'code'
