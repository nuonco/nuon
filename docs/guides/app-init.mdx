...
description: "Initialize and scaffold a Nuon app configuration with the CLI: choose a cloud platform, define components, and bootstrap the TOML files you need."
icon: 'code'
