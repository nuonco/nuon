...
description: "Scaffold a new Nuon application's configuration files from the CLI with nuon app init, then customize metadata, sandbox, and component TOML files."
icon: 'code'
