...
```bash
nuon apps init --prebuild-template aws-ecs
```

This generates a configuration optimized for deploying containerized applications to AWS Elastic Container Service (ECS).
