...
description: 'Scaffold a new Nuon app with nuon apps init — generate the metadata, sandbox, runner, and component TOML files you need to start packaging an application.'
icon: 'code'
