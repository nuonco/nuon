...
description: "Use Claude, Cursor, and other AI coding agents to scaffold, edit, and manage Nuon app configuration TOML files using docs and JSON Schema context."
icon: "robot"
