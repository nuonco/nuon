...
description: "Use AI coding agents like Claude and Cursor to generate, refactor, and maintain Nuon app configuration with the Nuon MCP server and provided context files."
icon: "robot"
