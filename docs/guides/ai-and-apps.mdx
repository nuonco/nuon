...
description: "Use terminal AI agents like Claude Code with the example-app-configs repo to scaffold and edit Nuon app configurations from natural language."
icon: "robot"
