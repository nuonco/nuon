...
description: 'Use Claude Code, Cursor, or any terminal AI agent with the nuon-plugin to scaffold and iterate on Nuon app TOML configuration files automatically.'
icon: "robot"
