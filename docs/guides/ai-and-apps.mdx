...
description: "Use AI coding agents like Cursor and Claude to scaffold, generate, and refactor Nuon app configurations, including components, sandboxes, and inputs."
icon: "robot"
