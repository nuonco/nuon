...
description: "Use Claude Code, Cursor, and other AI agents with the nuon-plugin to scaffold, modify, and operate Nuon app configurations from natural language."
icon: "robot"
