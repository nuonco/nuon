...
description: 'Use AI coding agents like Claude and Cursor to scaffold, generate, and maintain Nuon app configuration — TOML files, components, sandboxes, and install configs.'
icon: "robot"
