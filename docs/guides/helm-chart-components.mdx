...
description: 'Deploy any Helm chart from a public or connected repository as a Nuon component — configure namespace, values, values files, and storage driver per install.'
icon: "chart-simple"
