...
description: "Connect an existing Helm chart as a Nuon component and deploy it into each customer install with namespace, values, values files, and storage driver settings."
icon: "chart-simple"
