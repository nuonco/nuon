...
description: "Connect an existing Helm chart from Git or a Helm repo as a Nuon component — set values, override files, and deploy it to your customer's cluster."
icon: "chart-simple"
