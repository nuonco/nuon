...
description: 'Embed Nuon install management into your own product — use the REST API or Go SDK to create, provision, update, and deprovision installs from your dashboard.'
icon: "plug"
