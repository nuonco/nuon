---
title: "Embed Nuon BYOC into your product"
description: "Integrate the Nuon Control Plane API into your own product so customers create, manage, and view installs from your UI instead of the Nuon dashboard."
icon: "plug"
