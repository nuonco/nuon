...
description: 'Embed BYOC installs into your own product UI using the Nuon REST API and Go SDK — handle the full install lifecycle from inside your application.'
icon: "plug"
