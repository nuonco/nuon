...
description: 'Embed Nuon BYOC installs into your own product UI by integrating with the Nuon Control Plane API — let customers manage installs without leaving your app.'
icon: "plug"
