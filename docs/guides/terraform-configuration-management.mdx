...
Nuon also supports a [terraform component](/guides/terraform-components), which allows you to connect your existing
...
resource "nuon_install" "east_1" {
  ...
  depends_on = [
    nuon_app_sandbox.<your-app>,
    nuon_app_runner.<your-app>,
