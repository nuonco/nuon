...
icon: "comments"
keywords: ["MCP", "agents", "sample prompts", "prompts"]
---
...
## Get help writing app config

<AccordionGroup>
  <Accordion title="Write a README">
    ```
    Write a README for this app. Include a status section and links to the runbooks.
    ```
  </Accordion>
  <Accordion title="Add a policy">
    ```
    Add a policy that blocks public S3 buckets on the rds_cluster component.
    ```
  </Accordion>
</AccordionGroup>

More on these: [Skills](/guides/agents/skills).
