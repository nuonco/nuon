...
<AccordionGroup>
  ...
  <Accordion title="Changes in a branch run or PR preview">
    ```
  ...
  <Accordion title="Describe an install">
    ```
    Describe install acme-prod. Include what most recently updated it, its components, current health, and its rendered README.
    ```
  </Accordion>
