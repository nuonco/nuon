...
description: "Fork the open-source nuonco/install-stacks repo to customize the Terraform install stack templates for AWS or GCP to meet your requirements."
icon: "code-fork"
