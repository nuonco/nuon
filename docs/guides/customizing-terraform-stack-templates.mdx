...
description: 'Fork the open-source install-stacks repo to customize the Terraform install stack — change VPC sizing, IAM, or runner shape for your customers'' deployments.'
icon: "code-fork"
