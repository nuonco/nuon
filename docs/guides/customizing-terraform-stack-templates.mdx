...
description: 'Fork the open-source install-stacks repo and customize the Terraform install stack — change networking, IAM, and resources for every customer install.'
icon: "code-fork"
