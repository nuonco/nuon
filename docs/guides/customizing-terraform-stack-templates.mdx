...
description: 'Fork the open-source nuonco/install-stacks repo to customize the Terraform install stack with extra resources, modules, and customer-specific overrides.'
icon: "code-fork"
