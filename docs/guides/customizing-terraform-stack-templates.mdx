...
description: "Fork the open-source install-stacks repo to customize the Terraform install stack for your customers and ship tailored BYOC base infrastructure."
icon: "code-fork"
