...
description: "Use terraform_module components to provision infrastructure in customer cloud accounts — point at a module, set variables, and wire outputs to other components."
icon: "layer-group"
