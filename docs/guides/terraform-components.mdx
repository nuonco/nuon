...
provisioned as part of the initial Install Stack. e.g., in AWS, the stack
creates a VPC, ASG and and EC2 instance to start the runner. The runner is
separate from the Install's infrastructure e.g., Kubernetes cluster.
