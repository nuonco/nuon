...
description: "Terraform components let you provision infrastructure in your customer's cloud account using your existing Terraform modules — VPCs, clusters, and more."
icon: "layer-group"
