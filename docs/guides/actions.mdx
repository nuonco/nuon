---
title: 'Configure actions on installs'
description: 'Define custom action workflows in your Nuon app config and execute them remotely on installs — manual, scheduled, or lifecycle-triggered with break-glass roles.'
icon: "circle-play"
