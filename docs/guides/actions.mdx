...
description: "Define custom actions in your app TOML and remotely execute them inside an install — for migrations, healthchecks, jobs, and other operational tasks."
icon: "circle-play"
