...
description: 'Configure action workflows in your app''s TOML — define steps, triggers, env vars, and connected-repo sources so Nuon can run scripts on customer installs.'
icon: "circle-play"
