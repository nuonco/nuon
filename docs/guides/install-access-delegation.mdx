...
<Note>
We recommend enabling support access, so we can help you debug your delegation role while setting up your 
application.
</Note>
...
If you are using delegation for your application, your customer's will need to set the `delegation_role_arn` when 
  creating an install.
