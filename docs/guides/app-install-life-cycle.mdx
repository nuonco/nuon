...
description: 'Understand the full lifecycle of a Nuon app and install — packaging, syncing OCI artifacts, provisioning, deploying components, updating, and deprovisioning.'
