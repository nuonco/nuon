...
description: "Understand the full lifecycle of Nuon apps and installs: app sync, install provision, component deploys, drift detection, redeploys, and deprovision."
