...
description: "Understand the full life cycle of a Nuon app and its installs: from configuration and provisioning to upgrades, day-2 operations, and teardown."
