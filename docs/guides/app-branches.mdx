...
Omit `[run]` to run on every push and preview pull requests. To give a customer its own release cadence while still
tracking `main`, gate the branch with a tag prefix:
