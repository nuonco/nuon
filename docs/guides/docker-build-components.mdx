...
description: 'Build a Dockerfile from a connected GitHub repository as a Nuon component — configure build args, env vars, and build targets that ship to customer installs.'
icon: "docker"
