...
description: "Connect a Dockerfile from a Git repo as a Nuon Docker build component — Nuon builds the container image and pushes it to your customer's registry."
icon: "docker"
