...
description: "Automate Nuon app sync, component builds, and releases from GitHub Actions using the official nuonco/actions-build and actions-release workflows."
icon: "github"
