...
description: 'Use the official setup-nuon GitHub Action to install the Nuon CLI and automate nuon apps sync and component releases from your CI/CD pipelines.'
icon: "github"
