...
description: "Automatically sync Nuon apps from GitHub Actions on every push using the official setup-nuon-cli action to authenticate and run nuon apps sync in CI."
icon: "github"
