...
description: "Define inputs, app variables, and secrets in your Nuon app TOML config and reference them from sandboxes, components, and actions across every install."
icon: "gear"
boost: 8
