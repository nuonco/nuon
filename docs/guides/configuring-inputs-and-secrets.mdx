...
description: 'Step-by-step guide to defining inputs, variables, and secrets in your Nuon app''s TOML files so customers and vendors can parameterize every install.'
icon: "gear"
boost: 8
