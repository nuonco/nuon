...
description: "Define and use inputs, variables, and secrets in your Nuon app to configure components, actions, and infrastructure across every customer install."
icon: "gear"
boost: 8
