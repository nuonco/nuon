...
description: "Define and reference inputs, app variables, and secrets in a Nuon app to parameterize sandboxes, components, and actions for each customer install."
icon: "gear"
boost: 8
