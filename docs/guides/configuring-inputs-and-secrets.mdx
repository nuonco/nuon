...
description: "Define and consume inputs, app variables, and secrets across your Nuon app, then expose them to components, sandboxes, and actions at install time."
icon: "gear"
boost: 8
