...
description: 'Define inputs, variables, and secrets in your Nuon app TOML, template them across components, and let customers provide values securely at install time.'
icon: "gear"
boost: 8
