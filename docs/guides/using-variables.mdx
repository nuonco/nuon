...
description: 'Use template variables in your Nuon TOML configs — reference install IDs, inputs, secrets, and outputs across components, sandboxes, actions, and stacks.'
icon: "sliders"
