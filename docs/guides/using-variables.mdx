...
description: Reference inputs, app variables, and component outputs in your Nuon TOML config using Go template syntax to share values across an app's configs.
icon: "sliders"
