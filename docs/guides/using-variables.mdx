...
description: "Use template variables in Nuon configurations to reference inputs, secrets, app variables, sandbox outputs, and component outputs across your app."
icon: "sliders"
