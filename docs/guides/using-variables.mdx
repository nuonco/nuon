...
description: "Use variables in your Nuon TOML configuration to template values across components, inputs, and actions for cleaner and more reusable app configs."
icon: "sliders"
