...
description: "Use variables in Nuon configuration files to interpolate install inputs, app variables, secrets, and component outputs across your app definition."
icon: "sliders"
