...
description: 'Use Go-style template variables in your Nuon configs to interpolate inputs, secrets, sandbox outputs, and component outputs between components and actions.'
icon: "sliders"
