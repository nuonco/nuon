...
description: "Write OPA policies to enforce security and compliance requirements on external container images before they deploy to customer cloud accounts."
icon: "shield-halved"
