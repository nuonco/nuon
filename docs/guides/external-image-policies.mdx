...
description: "Write OPA policies that gate external container images on SBOM, signatures, attestations, and in-toto metadata before deploy to customer installs."
icon: "shield-halved"
