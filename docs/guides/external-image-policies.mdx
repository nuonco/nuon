...
description: "Write OPA policies that enforce security requirements on external container images, including registry, tag, and signature checks before a deploy."
icon: "shield-halved"
