...
description: 'Write OPA Rego policies to enforce security requirements on external container images — block unsigned, unscanned, or unapproved images at deploy time.'
icon: "shield-halved"
