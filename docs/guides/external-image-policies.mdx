...
description: 'Write OPA Rego policies that enforce image scanning, SBOM, and signature requirements on external container images before they deploy to a customer install.'
icon: "shield-halved"
