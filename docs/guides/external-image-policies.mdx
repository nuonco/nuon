...
description: 'Write OPA Rego policies that enforce signature checks, SBOM requirements, registry allowlists, and vulnerability rules on external container images.'
icon: "shield-halved"
