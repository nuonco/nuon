---
title: 'Create an AWS ECS BYOC App'
description: 'How to deploy a BYOC app to AWS ECS Fargate.'
icon: 'aws'
---

This guide walks you through creating a BYOC ECS application, that can be used to deploy to customer managed AWS accounts. You will set up a Nuon app, create an install in AWS, and deploy the app to the install.
