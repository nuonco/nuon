...
description: "Let customers pause or permanently stop the Nuon runner from their own AWS account using the runner kill switch, halting all deploys and actions on demand."
icon: "power-off"
