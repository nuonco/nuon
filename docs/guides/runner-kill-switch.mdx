---
title: "Customer-controlled runner kill switch"
description: "Give customers a self-service way to pause or permanently stop the Nuon runner from their own AWS account in case of incident or contract end."
icon: "power-off"
