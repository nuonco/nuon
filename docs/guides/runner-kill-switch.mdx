...
description: "How customers can pause or permanently stop the Nuon runner from their own AWS account using the kill switch for incident response and compliance."
icon: "power-off"
