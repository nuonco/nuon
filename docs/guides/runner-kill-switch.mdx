...
description: "How a customer can pause or permanently stop the Nuon Runner directly from their AWS account by scaling the runner's Auto Scaling Group to zero."
icon: "power-off"
