...
The runner is managed via the stack, and is responsible for all actions. While you can also remove permissions, you can also entirely disable the runner. This is useful for partial-customer-managed installs, release windows and customers who want more control.
