...
description: 'How customers can pause or permanently stop the Nuon Runner inside their own AWS account using the install stack — no vendor or Nuon action required.'
icon: "power-off"
