...
description: 'How customers can pause or shut down the Nuon runner from their AWS account using the Auto Scaling Group — useful for release windows and air-gapped windows.'
icon: "power-off"
