...
description: 'Extend the Nuon install stack with custom CloudFormation nested templates — ship extra IAM, networking, or storage resources alongside the runner and VPC.'
icon: "layer-group"
