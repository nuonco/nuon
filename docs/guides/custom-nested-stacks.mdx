...
description: "Extend the Nuon install stack with custom CloudFormation nested templates to add resources or customize provisioning in customer AWS accounts."
icon: "layer-group"
