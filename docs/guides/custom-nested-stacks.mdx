...
description: 'Extend the Nuon install CloudFormation template with custom nested stacks — add VPC peering, security groups, or shared resources alongside the default stack.'
icon: "layer-group"
