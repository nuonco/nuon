...
description: "Extend the AWS install stack with your own CloudFormation nested templates to provision custom resources before sandboxes and components run."
icon: "layer-group"
