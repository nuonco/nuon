...
description: "Extend the Nuon install stack with custom CloudFormation nested templates to add resources, IAM, and integrations beyond the default sandbox."
icon: "layer-group"
