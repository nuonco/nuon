...
description: 'Extend the Nuon install stack with custom nested CloudFormation templates to provision additional resources beyond the built-in VPC and runner stacks.'
icon: "layer-group"
