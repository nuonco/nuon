...
description: "Extend the AWS install stack with custom CloudFormation nested templates that add VPCs, IAM, or other resources alongside the default Nuon stack."
icon: "layer-group"
