---
title: 'Webhooks'
description: "Receive workflow lifecycle events from your Nuon org as CloudEvents over HTTP and integrate them into Slack, PagerDuty, or your own observability pipeline."
icon: 'webhook'
