...
icon: "code"
boost: 10
keywords: ["creating installs", "install-config", "install config", "install configuration", "install.toml", "install schema", "install file", "install configuration reference", "install config reference", "configure install", "programmatic install", "json install config", "automated install onboarding", "generate install config", "labels", "install labels", "label badge", "monitor workflows", "deploy notifications"]
---
...
## Generating install configs at scale
