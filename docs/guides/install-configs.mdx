...
description: 'Generate per-install configuration files from code using JSON Schema — manage approvals, custom nested stacks, and runner overrides in source control.'
icon: "code"
boost: 10
