...
description: "Manage installs as code with install.toml files — generate configs from JSON Schema, version them in Git, and apply them to Nuon installs automatically."
icon: "code"
boost: 10
