...
description: "Generate per-install configuration files from code using JSON Schema to override stack templates, custom nested stacks, and approval options programmatically."
icon: "code"
boost: 10
