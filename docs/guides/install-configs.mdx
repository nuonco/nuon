...
description: "Generate install config files from code using JSON Schema so customers and operators can manage installs declaratively, versioned in source control."
icon: "code"
boost: 10
