...
description: 'Generate per-install Nuon config files from your existing schemas using JSON Schema — manage install inputs, secrets, and metadata via source control.'
icon: "code"
boost: 10
