...
description: "Define each install declaratively with install.toml, generate it from code using the published JSON Schema, and sync configs from source control."
icon: "code"
boost: 10
