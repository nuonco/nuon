...
You can use `terraform` to create and manage IAM roles for creating / destroying Nuon installs using our `iam-role` module. This module is located in the [sandboxes](https://github.com/nuonco/sandboxes) repo.
