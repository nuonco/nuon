...
description: "Run a one-off command or bash script on a Nuon install from the CLI or dashboard without defining the action up front in your app's TOML configuration."
icon: "circle-play"
