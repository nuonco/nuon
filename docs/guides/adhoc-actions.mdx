...
description: "Run a one-off command or bash script on a Nuon install without defining it in your app's TOML config — useful for debugging and quick maintenance."
icon: "circle-play"
