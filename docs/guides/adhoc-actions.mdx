---
title: 'Run ad-hoc actions on installs'
description: "Run a one-off command or bash script against any install without adding it to your app's TOML config — useful for debugging, migrations, and emergencies."
icon: "circle-play"
