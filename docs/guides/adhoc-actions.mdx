...
description: "Run one-off bash commands or scripts against a Nuon install from the CLI — debug, inspect, or run quick fixes without editing your app's TOML config."
icon: "circle-play"
