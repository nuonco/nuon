...
description: "Run a one-off command or bash script on a Nuon install without defining it in your app's TOML config — perfect for debugging and manual operations."
icon: "circle-play"
