...
description: 'Run a one-off bash command or script on a Nuon install from the CLI or dashboard without defining it in your app config — useful for debugging and ad-hoc tasks.'
icon: "circle-play"
