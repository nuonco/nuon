...
<Note>
Please refer to the [Terraform configuration management guide](/guides/terraform-configuration-management) for more
...
```sh
nuon installs update-input --install-id=inlju8zs1g3ohctqwdtqrhizp5 --name=aws-eks-version --value=v1.29
```
