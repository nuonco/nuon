...
You can create an installer for an app by adding an `installer` block to the app config.
...
Once an installer is created, an out-of-the-box UI can be accessed at `<slug>.app.nuon.co`.

### Custom UI

You can also build a custom UI, and pull installer data from our API. We maintain an [open-source template](https://github.com/nuonco/installer) you can use to get started.
