...
description: "Kubernetes manifest components let you deploy raw Kubernetes resources directly into customer Kubernetes clusters without building a Helm chart."
icon: "dharmachakra"
