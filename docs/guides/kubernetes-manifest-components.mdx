...
description: "Deploy raw Kubernetes manifests as Nuon components directly into your customer's cluster — no Helm chart required for simple namespaced resources."
icon: "dharmachakra"
