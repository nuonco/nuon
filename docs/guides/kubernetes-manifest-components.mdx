...
description: "Use kubernetes_manifest components to deploy raw Kubernetes YAML resources — Deployments, Services, CRDs, kustomize bases — directly into customer clusters."
icon: "dharmachakra"
