...
description: "Use kubernetes-manifest components to deploy raw Kubernetes resources directly into a customer's cluster without packaging them as a Helm chart."
icon: "dharmachakra"
