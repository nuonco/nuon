...
description: "Kubernetes manifest components let you deploy raw Kubernetes resources directly into your customer's cluster through Nuon installs and workflows."
icon: "dharmachakra"
