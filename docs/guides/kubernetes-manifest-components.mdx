...
description: "Deploy raw Kubernetes YAML manifests directly into your customer's cluster as a Nuon component — no Helm required, with templating and overlays."
icon: "dharmachakra"
