...
description: "Connect raw Kubernetes manifests as Nuon components to deploy any resource — Deployments, Services, CRDs — directly into customer Kubernetes clusters."
icon: "dharmachakra"
