---
title: 'API'
description: 'Get started with the Nuon REST API — generate an access token via the dashboard or CLI, then call endpoints to manage apps, installs, components, and actions.'
boost: 10
