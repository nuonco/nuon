---
title: 'API'
description: "Get started using the Nuon control plane API — authenticate, explore endpoints, and integrate Nuon into your own automation and CI/CD pipelines."
boost: 10
