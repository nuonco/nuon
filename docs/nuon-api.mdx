---
title: 'Nuon Control Plane API'
description: "Authenticate with a bearer token and call the Nuon Control Plane REST API to create, configure, and manage apps and installs programmatically."
boost: 10
