---
title: 'API'
description: "Get started with the Nuon Control Plane REST API to programmatically create apps, manage installs, trigger workflows, and integrate Nuon into your tooling."
boost: 10
