---
title: 'API'
description: "Authenticate with an access token and call the Nuon Control Plane REST API to create, configure, and manage apps and installs programmatically."
boost: 10
