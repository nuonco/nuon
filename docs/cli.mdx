---
title: 'CLI'
description: 'Install the Nuon CLI via Homebrew, set up shell autocomplete and authentication, and start managing apps, installs, components, and runners from your terminal.'
boost: 2
