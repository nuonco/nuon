---
title: 'CLI'
description: 'Install the Nuon CLI on macOS, Linux, or Windows using Homebrew or the install script to manage apps, installs, and components from your terminal.'
boost: 2
