---
title: 'CLI'
description: "Install the Nuon CLI on macOS, Linux, or Windows with Homebrew or a binary download, then authenticate and manage apps and installs from your terminal."
boost: 2
