...
description: "Install the Nuon command-line tool to manage apps, components, and installs from your terminal, with Homebrew, install script, and binary options."
boost: 2
