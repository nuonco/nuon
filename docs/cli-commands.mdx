...
These subcommands take the app **ID** (`app...`), not the app name — get it from `nuon apps list`. Select an app with
`nuon apps select` and you can omit `--app-id` from `trigger` and `runs`.
