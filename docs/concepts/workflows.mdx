...
title: "Workflows"
icon: "circle-nodes"
description: "Workflows orchestrate the sequence of operations Nuon executes during an install lifecycle, including sandbox sync, component deploys, and custom actions."
boost: 4
