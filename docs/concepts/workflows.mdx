...
title: "Workflows"
icon: "circle-nodes"
description: "Workflows are scheduled and manual lifecycles that deploy, update, drift-check, and tear down apps, components, and actions on customer installs."
boost: 4
