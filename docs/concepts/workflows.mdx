...
title: "Workflows"
icon: "circle-nodes"
description: "Workflows orchestrate the lifecycle of deploying, updating, and tearing down Nuon apps, components, and actions — with plans, approvals, and retries."
boost: 4
