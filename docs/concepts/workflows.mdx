...
title: "Workflows"
icon: "circle-nodes"
description: 'Workflows are the scheduled or manual lifecycles that deploy, update, drift-scan, and tear down Nuon apps, components, sandboxes, and actions on an install.'
boost: 4
