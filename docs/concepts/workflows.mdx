...
title: "Workflows"
icon: "circle-nodes"
description: 'Workflows are the scheduled and manual lifecycles Nuon runs to provision, deploy, update, retry, and tear down apps, components, and actions across installs.'
boost: 4
