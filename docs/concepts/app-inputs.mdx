...
title: "Inputs"
icon: "sliders"
description: 'Define inputs.toml parameters — customer- or vendor-provided values — that configure each Nuon install''s sandbox, components, and Terraform or Helm variables.'
