...
title: "Inputs"
icon: "sliders"
description: 'Define customer-supplied configuration values for your Nuon app — strings, numbers, booleans, and JSON — that templates reference at install time.'
