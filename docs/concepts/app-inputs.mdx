...
title: "Inputs"
icon: "sliders"
description: "Define customer-provided values like regions, sizes, and feature flags to configure each install of your app with vendor or user-facing inputs."
