---
title: "App inputs in Nuon"
icon: "sliders"
description: "Define vendor and customer inputs that parameterize each install of your Nuon app, including required fields, defaults, groups, and validation rules."
