...
title: "Inputs"
icon: "sliders"
description: "App inputs let vendors define customer-provided values that parameterize sandboxes, components, and actions, with required, default, and sensitive fields."
