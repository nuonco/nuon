...
title: "Inputs"
icon: "sliders"
description: "Inputs are vendor- or customer-supplied values that parameterize a Nuon app, feeding into Terraform variables, Helm values, and component configs per install."
