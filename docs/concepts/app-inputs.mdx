...
title: "Inputs"
icon: "sliders"
description: "Define vendor- and customer-provided inputs to configure your Nuon app — wire values into sandboxes, components, Helm values, and Terraform variables."
