...
and equally by a `[public_repo]` branch whose owner your org has connected — a public `acmeco/*` repo gets previews as
long as the org has connected `acmeco`. See [connecting a repository](/guides/vcs).
