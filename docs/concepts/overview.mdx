---
title: 'Nuon Concepts: Apps, Installs, and Day-2 Operations'
description: 'Overview of the core Nuon concepts — apps, components, sandboxes, runners, installs, workflows, actions, and policies — that make up the BYOC platform.'
icon: "compass"
