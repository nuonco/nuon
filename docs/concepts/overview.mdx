---
title: "Core Nuon concepts and BYOC overview"
description: "Get up to speed on BYOC and how Nuon's core concepts — apps, components, installs, runners, sandboxes — fit together to deploy software into customer clouds."
icon: "compass"
