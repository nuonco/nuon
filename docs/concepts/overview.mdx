...
icon: "compass"
keywords: ["BYOC", "bring your own cloud", "concepts", "platform overview", "how Nuon works", "BYOC vs SaaS", "BYOC vs single tenant", "BYOC vs self-hosted", "build vs buy BYOC", "build BYOC in-house alternative", "managed BYOC", "BYOC as a service", "BYOC deployment platform", "API token", "service account", "authentication"]
---
...
<CardGroup cols={2}>
  ...
  <Card title="Triggers" icon="bolt" href="/concepts/triggers">
    Route external webhook events to app branch runs and install runbooks.
  </Card>

  <Card title="API Tokens" icon="key" href="/concepts/api-tokens">
    Org-scoped tokens for authenticating to the Nuon Control Plane API.
  </Card>

  <Card title="Service Accounts" icon="robot" href="/concepts/service-accounts">
    Named machine identities for automation, CI/CD, and runners.
  </Card>
