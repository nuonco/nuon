...
title: "Glossary"
icon: "book"
description: "Definitions for the core terms used across Nuon: vendor, customer, app, install, runner, sandbox, component, workflow, action, control plane, and more."
boost: 2.5
