...
icon: "rotate-right"
description: "Set max_auto_retries on a component so Nuon automatically re-plans and re-applies after transient failures during sandbox or component workflows."
keywords: [
  "auto retry",
  "auto retries",
  "auto-retry",
