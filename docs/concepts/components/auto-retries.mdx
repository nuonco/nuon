---
title: "Auto retries for Nuon components"
sidebarTitle: "Auto Retries"
icon: "rotate-right"
description: "Bound automatic retries per component on transient deploy failures using max_auto_retries for Helm, Terraform, Kubernetes, Docker, and container components."
keywords: [
  "auto retry",
  "auto retries",
  "auto-retry",
