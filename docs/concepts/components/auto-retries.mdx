...
icon: "rotate-right"
description: "Configure components with max_auto_retries to automatically re-plan and re-apply on transient failures without retrying broken components forever."
keywords: [
  "auto retry",
  "auto retries",
  "auto-retry",
