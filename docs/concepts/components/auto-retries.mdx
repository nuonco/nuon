...
icon: "rotate-right"
description: 'Configure Nuon components with max_auto_retries so transient plan or apply failures automatically re-run before surfacing the error to operators.'
keywords: [
  "auto retry",
  "auto retries",
  "auto-retry",
