...
icon: "rotate-right"
description: 'Set max_auto_retries on a Nuon component to automatically re-plan and re-apply after transient failures like rate limits, timeouts, or eventual consistency.'
keywords: [
  "auto retry",
  "auto retries",
  "auto-retry",
