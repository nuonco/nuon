...
icon: "rotate-right"
description: "Configure components to automatically re-plan and re-apply on transient deploy failures using max_auto_retries — bounded retries with no runaway loops."
keywords: [
  "auto retry",
  "auto retries",
  "auto-retry",
