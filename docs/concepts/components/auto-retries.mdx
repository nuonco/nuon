...
icon: "rotate-right"
description: "Configure Nuon components to automatically re-plan and re-apply on transient deploy failures by setting max_auto_retries in the component configuration."
keywords: [
  "auto retry",
  "auto retries",
  "auto-retry",
