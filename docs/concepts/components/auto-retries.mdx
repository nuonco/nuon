...
icon: "rotate-right"
description: "Configure Nuon components to automatically re-plan and re-apply on transient failures by setting the max_auto_retries option in your config."
keywords: [
  "auto retry",
  "auto retries",
  "auto-retry",
