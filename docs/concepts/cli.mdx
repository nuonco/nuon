---
title: "CLI"
description: "Use the Nuon CLI to authenticate, create installs, trigger workflows, run actions, fetch logs, and manage the full install lifecycle from your terminal."
icon: "terminal"
