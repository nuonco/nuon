---
title: "CLI"
description: 'Use the Nuon CLI to create installs, deploy components, run actions, and manage the full install lifecycle directly from your terminal or CI pipeline.'
icon: "terminal"
