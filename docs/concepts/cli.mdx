...
The `nuon` CLI is the fastest path for engineers embedding install management in scripts, CI jobs, or a provisioning workflow. Anything you can do in the [web app](/concepts/web-app) has a CLI counterpart.
