---
title: 'Nuon CLI'
description: 'Manage the full app and install lifecycle from your terminal — sync apps, trigger deploys, run actions, follow workflows, and switch orgs with the nuon CLI.'
icon: "terminal"
