---
title: "Manage installs with the Nuon CLI"
description: "Use the Nuon CLI to authenticate, create installs, run workflows, manage components, and embed install lifecycle commands into your own scripts and CI."
icon: "terminal"
