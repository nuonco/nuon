...
title: "App Variables"
icon: "code"
description: "Store API-managed values that are shared across every install of an app, useful for centrally controlled config like license keys or endpoints."
