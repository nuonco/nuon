...
Using our example secret named `external_api_key`, you could reference its
value in your app with the template expression `{{ .nuon.app.variables.external_api_key }}`.
