...
title: "App Variables"
icon: "code"
description: "Store non-sensitive values through the Nuon API and reference them in templates so a single value can be reused across every install of an app."
