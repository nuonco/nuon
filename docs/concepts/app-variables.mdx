...
title: "App Variables"
icon: "code"
description: "App Variables let you store values in the Nuon API and reference them across every install of an app for shared, non-secret configuration values."
