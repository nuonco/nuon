...
title: "App Variables"
icon: "code"
description: "Use app variables to share computed values across components, sandboxes, and actions within a Nuon install without re-declaring them in each config block."
