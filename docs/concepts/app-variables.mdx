...
title: "App Variables"
icon: "code"
description: 'Store app-level values through the Nuon API to share configuration across every install of an app without committing the value to your TOML config.'
