...
title: "App Variables"
icon: "code"
description: "Store and reuse vendor-controlled values across every install of an app, set through the API and referenced in component configs, actions, and inputs."
