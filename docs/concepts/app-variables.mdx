...
title: "App Variables"
icon: "code"
description: 'Store shared values through the Nuon API and reference them across every install of an app — useful for shared config, feature flags, and default values.'
