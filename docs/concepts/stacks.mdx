...
title: "Stacks"
icon: "layer-group"
description: "Stacks are cloud-native CloudFormation or Terraform templates that bootstrap an install — provisioning the VPC, runner, and foundational resources."
---
