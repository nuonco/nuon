...
title: "Stacks"
icon: "layer-group"
description: "Stacks are cloud-native CloudFormation or Terraform templates that bootstrap each install in a customer's cloud account with the resources Nuon needs."
---
