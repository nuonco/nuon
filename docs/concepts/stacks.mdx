...
title: "Stacks"
icon: "layer-group"
description: 'Stacks are the CloudFormation, Bicep, or Terraform templates Nuon generates to bootstrap the runner and base infrastructure in a customer''s cloud account.'
---
