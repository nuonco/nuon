...
title: "Stacks"
icon: "layer-group"
description: "Stacks are cloud-native templates — CloudFormation, ARM, Terraform — that bootstrap an install in a customer's cloud account and create the Nuon runner."
---
