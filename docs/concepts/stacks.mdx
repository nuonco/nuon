...
title: "Stacks"
icon: "layer-group"
description: "Stacks are CloudFormation, Bicep, or Terraform templates that bootstrap an install — provisioning the runner and foundational resources in a customer's cloud."
---
