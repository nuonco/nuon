...
- **[Secrets](/concepts/app-secrets)** — entered by the customer as CloudFormation parameters or Terraform variables, then stored in the customer's cloud secret manager (e.g., AWS Secrets Manager).
