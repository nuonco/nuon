...
title: "Stacks"
icon: "layer-group"
description: 'Cloud-native install stacks (CloudFormation, Azure Bicep, or Terraform) that bootstrap a Nuon install in a customer cloud account with runner and IAM roles.'
---
