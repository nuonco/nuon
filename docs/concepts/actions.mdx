...
title: "Actions"
icon: "circle-play"
description: 'Automate operational tasks on installs with Nuon Actions — define scheduled, manual, or lifecycle-triggered workflows that run inside the customer environment.'
