...
title: "Actions"
icon: "circle-play"
description: "Define and run custom action workflows on Nuon installs to automate day-2 operational tasks like data migrations, health checks, and remediations."
