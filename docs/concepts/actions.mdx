...
title: "Actions"
icon: "circle-play"
description: "Automate operational tasks and workflows across your installs — run scheduled jobs, ad hoc commands, and lifecycle hooks in customer environments."
