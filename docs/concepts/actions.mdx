...
title: "Actions"
icon: "circle-play"
description: "Define remote, on-demand actions that run inside an install's cloud account — scripts, jobs, and ad-hoc workflows you can trigger from the CLI or dashboard."
