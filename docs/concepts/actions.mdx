...
title: "Actions"
icon: "circle-play"
description: "Define and remotely run scripted actions on customer installs for break-glass operations, health checks, migrations, and other day-2 automation tasks."
