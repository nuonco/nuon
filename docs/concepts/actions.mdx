...
title: "Actions"
icon: "circle-play"
description: 'Actions are reusable, scheduled, or on-demand workflows that automate health checks, runbooks, migrations, and break-glass operations on Nuon installs.'
