...
title: "Sandboxes"
icon: "border-all"
description: "Sandboxes provision the base infrastructure — VPCs, clusters, databases — that every Nuon install needs inside the customer's cloud before components deploy."
