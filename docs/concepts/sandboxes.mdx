...
title: "Sandboxes"
icon: "border-all"
description: "Sandboxes provision and manage the base infrastructure layer — networking, IAM, and shared resources — for an app in each customer's cloud account."
