...
title: "Sandboxes"
icon: "border-all"
description: "Sandboxes are the per-install Terraform workspace that Nuon provisions to create the VPC, IAM, and shared infrastructure components depend on."
