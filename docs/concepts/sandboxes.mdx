...
title: "Sandboxes"
icon: "border-all"
description: "Sandboxes provision the base layer infrastructure — VPCs, clusters, IAM, and networking — for your Nuon application in each customer's cloud account."
