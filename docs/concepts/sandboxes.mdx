...
title: "Sandboxes"
icon: "border-all"
description: 'Sandboxes are the base-layer Terraform infrastructure — VPCs, EKS or AKS clusters, IAM — that Nuon provisions in a customer account before deploying components.'
