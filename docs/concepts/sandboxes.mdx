...
title: "Sandboxes"
icon: "border-all"
description: "Sandboxes provision the base infrastructure — VPCs, Kubernetes clusters, IAM — for your app inside each customer's cloud account before components deploy."
