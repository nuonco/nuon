...
title: "Sandboxes"
icon: "border-all"
description: "Sandboxes provision the per-customer base infrastructure — VPCs, Kubernetes clusters, networking — that components and apps run on inside each install."
