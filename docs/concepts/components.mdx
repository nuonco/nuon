...
title: "Components"
icon: "object-group"
description: "Components are the deployable building blocks of a Nuon app — Helm charts, Terraform modules, Docker builds, Kubernetes manifests, and container images."
boost: 9
