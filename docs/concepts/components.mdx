...
title: "Components"
icon: "object-group"
description: "Connect existing container images, Helm charts, Kubernetes manifests, Docker builds, and Terraform modules as components that deploy into customer installs."
boost: 9
