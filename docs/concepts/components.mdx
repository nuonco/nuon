...
title: "Components"
icon: "object-group"
description: "Build a Nuon app from your existing container images, Docker builds, Helm charts, Kubernetes manifests, and Terraform modules — each modeled as a component."
boost: 9
