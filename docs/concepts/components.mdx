...
title: "Components"
icon: "object-group"
description: 'Components wrap your existing Helm charts, Terraform modules, Kubernetes manifests, Docker builds, and container images so Nuon can deploy them as a unit.'
boost: 9
