---
title: "Dashboard"
description: "Use the Nuon dashboard to view installs, run actions, inspect logs, approve workflows, and manage app and install configurations across all environments."
icon: "browser"
---
