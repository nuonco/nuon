...
description: 'Tour the Nuon dashboard: view apps, drive installs, monitor runners and sandboxes, follow workflows, run actions, and audit changes from a single web UI.'
icon: "browser"
---
