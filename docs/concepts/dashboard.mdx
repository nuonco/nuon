---
title: "Manage installs in the Nuon dashboard"
description: "What you can do for installs in the Nuon dashboard — create installs, monitor workflows, approve plan diffs, redeploy components, and run actions."
icon: "browser"
---
