---
title: "Dashboard"
description: "What you can do in the Nuon dashboard: create installs, share stack links, monitor workflows, approve plan diffs, run actions, and update inputs in place."
icon: "browser"
---
