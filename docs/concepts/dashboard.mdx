---
title: "Dashboard"
description: 'Use the Nuon dashboard to create installs, share stack links, approve plans, run actions, monitor workflows, and reprovision customer environments.'
icon: "browser"
---
