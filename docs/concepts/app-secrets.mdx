...
title: "Secrets"
icon: "key"
description: "Define and manage sensitive values like credentials, API keys, and tokens used to configure app components and actions across each customer install."
