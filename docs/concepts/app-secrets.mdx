...
title: "Secrets"
icon: "key"
description: "Define and manage sensitive values like credentials, API keys, and tokens used by components and actions, with sync to AWS Secrets Manager and Kubernetes."
