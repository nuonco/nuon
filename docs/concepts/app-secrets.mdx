---
title: "Secrets in Nuon apps"
icon: "key"
description: "Store sensitive values like API tokens and credentials in app secrets, then inject them into components, sandboxes, and Kubernetes during install workflows."
