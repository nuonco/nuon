...
title: "Secrets"
icon: "key"
description: 'Define and manage sensitive values — API keys, tokens, database credentials — that Nuon stores in the customer''s cloud secrets manager, never in Nuon.'
