...
title: "Secrets"
icon: "key"
description: 'Define sensitive values like credentials, API keys, and tokens that customers supply at install time and stay encrypted in their own cloud secret manager.'
