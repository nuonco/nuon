---
title: 'AWS'
description: "Supported AWS services and primitives for Nuon BYOC — EKS, ECS, EC2, Lambda, IAM, VPC, and the AWS resources runners and sandboxes provision per install."
icon: 'amazon'
boost: 1.5
