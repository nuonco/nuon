---
title: 'AWS'
description: 'Deploy and manage BYOC apps on AWS with Nuon — supported regions, EKS, CloudFormation stacks, cross-account IAM patterns, and GovCloud or Organizations support.'
icon: 'amazon'
boost: 1.5
