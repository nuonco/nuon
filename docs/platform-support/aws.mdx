---
title: 'AWS'
description: "Deploy and manage Nuon BYOC apps on AWS — supported regions, IAM roles, CloudFormation stacks, EKS support, GovCloud, and account onboarding details."
icon: 'amazon'
boost: 1.5
