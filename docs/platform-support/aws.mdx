---
title: 'AWS'
description: "Deploy and manage BYOC Nuon apps on AWS, including supported regions, runner types (ECS, EKS), Terraform install stacks, and AWS-specific components."
icon: 'amazon'
boost: 1.5
