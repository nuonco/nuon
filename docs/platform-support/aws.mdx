---
title: "AWS platform support in Nuon"
description: "Deploy and manage BYOC apps on Amazon Web Services with Nuon, including supported services, IAM model, regions, and what's available on EC2, EKS, and Lambda."
icon: 'amazon'
boost: 1.5
