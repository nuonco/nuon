...
Builds run in the [Control Plane](/architecture/platform#builds) and never touch your install infrastructure. Build artifacts are stored as OCI images in the customer's cloud registry.
