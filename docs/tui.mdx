---
title: "TUI"
description: "Use the Nuon CLI terminal user interfaces to follow install workflows in real time, inspect step details, and trigger actions without leaving your shell."
