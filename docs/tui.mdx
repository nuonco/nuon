---
title: "TUI"
description: 'Use the Nuon CLI''s terminal UIs to follow workflow steps in real time and trigger actions on installs — workflow TUI and actions TUI for faster operator loops.'
