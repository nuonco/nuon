---
title: "Nuon terminal user interface (TUI)"
description: "Use Nuon's terminal user interfaces to follow install workflows, approve plan diffs, retry failed steps, and trigger actions interactively from the CLI."
