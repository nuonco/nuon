---
title: "TUI"
description: 'Run install workflows and trigger ad-hoc actions from your terminal with the Nuon workflow and actions TUIs — approve steps, retry, and stream logs live.'
