---
title: "Dashboard"
description: "Manage Nuon apps and customer installs from the web dashboard, including stack links, workflow approvals, action runs, redeploys, and input updates."
boost: 0.1
