---
title: "Dashboard"
description: 'Manage Nuon apps and installs from the web dashboard — create installs, share stack links, approve workflows, run actions, and monitor deployments at a glance.'
boost: 0.1
