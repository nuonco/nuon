...
description: "Define a Nuon BYOC app with TOML configuration files for metadata, sandboxes, components, inputs, and secrets, then sync them with the nuon CLI."
