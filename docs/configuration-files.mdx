---
title: "Nuon configuration files"
description: "Define your Nuon app, components, sandboxes, inputs, and secrets using TOML configuration files that live alongside your application source code."
