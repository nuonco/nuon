...
description: "Configure Nuon apps using TOML files that define metadata, sandboxes, components, inputs, secrets, and actions in a single versioned app directory."
