...
description: 'Overview of the TOML configuration files that define a Nuon app — metadata, sandbox, components, inputs, secrets, policies, and actions in your app directory.'
