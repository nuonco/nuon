...
func (c *cli) buildsCmd() *cobra.Command {
	...
	listCmd := &cobra.Command{
		...
		Run: c.wrapCmd(BuildsListEvent, func(cmd *cobra.Command, _ []string) error {
	...
	getCmd := &cobra.Command{
		...
		Run: c.wrapCmd(BuildsGetEvent, func(cmd *cobra.Command, _ []string) error {
			svc := builds.New(c.apiClient, c.cfg)
	...
	createCmd := &cobra.Command{
		...
		Run: c.wrapCmd(BuildsCreateEvent, func(cmd *cobra.Command, _ []string) error {
			svc := builds.New(c.apiClient, c.cfg)
	...
	logsCmd := &cobra.Command{
		...
		Run: c.wrapCmd(BuildsLogsEvent, func(cmd *cobra.Command, _ []string) error {
			svc := builds.New(c.apiClient, c.cfg)
