...
func (c *cli) appsCmd() *cobra.Command {
	...
	listCmd := &cobra.Command{
		...
		Run: c.wrapCmd(AppsListEvent, func(cmd *cobra.Command, _ []string) error {
	...
	getCmd := &cobra.Command{
		...
		Run: c.wrapCmd(AppsGetEvent, func(cmd *cobra.Command, _ []string) error {
			svc := apps.New(c.v, c.apiClient, c.cfg)
	...
	currentCmd := &cobra.Command{
		...
		Run: c.wrapCmd(AppsCurrentEvent, func(cmd *cobra.Command, _ []string) error {
			svc := apps.New(c.v, c.apiClient, c.cfg)
	...
	latestSandboxConfigCmd := &cobra.Command{
		...
		Run: c.wrapCmd(AppsSandboxConfigEvent, func(cmd *cobra.Command, _ []string) error {
			svc := apps.New(c.v, c.apiClient, c.cfg)
	...
	configs := &cobra.Command{
		...
		Run: c.wrapCmd(AppsConfigEvent, func(cmd *cobra.Command, _ []string) error {
			svc := apps.New(c.v, c.apiClient, c.cfg)
	...
	latestInputConfig := &cobra.Command{
		...
		Run: c.wrapCmd(AppsInputConfigEvent, func(cmd *cobra.Command, _ []string) error {
			svc := apps.New(c.v, c.apiClient, c.cfg)
	...
	latestRunnerConfig := &cobra.Command{
		...
		Run: c.wrapCmd(AppsRunnerConfigEvent, func(cmd *cobra.Command, _ []string) error {
			svc := apps.New(c.v, c.apiClient, c.cfg)
	...
	selectAppCmd := &cobra.Command{
		...
		Run: c.wrapCmd(AppsSelectEvent, func(cmd *cobra.Command, _ []string) error {
			svc := apps.New(c.v, c.apiClient, c.cfg)
	...
	unsetCurrentAppCmd := &cobra.Command{
		...
		Run: c.wrapCmd(AppsUnsetCurrentEvent, func(cmd *cobra.Command, _ []string) error {
			svc := apps.New(c.v, c.apiClient, c.cfg)
	...
	syncCmd := &cobra.Command{
		...
		PersistentPreRunE: c.persistentPreRunE,
		Run: c.wrapCmd(AppsSyncEvent, func(cmd *cobra.Command, _ []string) error {
			svc := apps.New(c.v, c.apiClient, c.cfg)
	...
	validateCmd := &cobra.Command{
		...
		PersistentPreRunE: c.persistentPreRunE,
		Run: c.wrapCmd(AppsValidateEvent, func(cmd *cobra.Command, _ []string) error {
			svc := apps.New(c.v, c.apiClient, c.cfg)
	...
	deleteCmd := &cobra.Command{
		...
		PersistentPreRunE: c.persistentPreRunE,
		Run: c.wrapCmd(AppsDeleteEvent, func(cmd *cobra.Command, _ []string) error {
			svc := apps.New(c.v, c.apiClient, c.cfg)
	...
	renameCmd := &cobra.Command{
		...
		Short:             "Rename an app",
		PersistentPreRunE: c.persistentPreRunE,
		Run: c.wrapCmd(AppsRenameEvent, func(cmd *cobra.Command, _ []string) error {
			svc := apps.New(c.v, c.apiClient, c.cfg)
