...
# rendezvous used by air-gapped installs.
#
...
#   - set (air-gapped installs): write the payload JSON to the customer's S3 bucket
#     and skip the control-plane POST entirely. The airgap runner polls the same
