...
//
// diagnosis, when present, is preserved ahead of spec in the fallback order:
// it is the smallest and most useful part of the payload, and it is what the
// evaluator copies onto a health transition.
