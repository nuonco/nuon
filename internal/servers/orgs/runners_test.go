...
//func Test_server_GetRunners(t *testing.T) {
//orgCtx := getFakeOrgContext()
//orgID := uuid.NewString()
//getRunnersResp := &orgsv1.GetRunnersResponse{}
//testErr := fmt.Errorf("test")

//tests := map[string]struct {
//serverFn    func(*testing.T, *gomock.Controller) *server
//reqFn	    func(*testing.T) *connect.Request[orgsv1.GetRunnersRequest]
//assertFn    func(*testing.T, *connect.Response[orgsv1.GetRunnersResponse])
//errExpected error
//}{
//"happy path": {
...
//mockSvc.EXPECT().GetRunners(gomock.Any(), orgID).Return(getRunnersResp, nil)

//srv, err := New(WithContextProvider(mockOrgCtx), WithService(mockSvc))
//assert.NoError(t, err)
//return srv
//},
//reqFn: func(t *testing.T) *connect.Request[orgsv1.GetRunnersRequest] {
//return connect.NewRequest(&orgsv1.GetRunnersRequest{
//OrgId: orgID,
//})
//},
//assertFn: func(t *testing.T, res *connect.Response[orgsv1.GetRunnersResponse]) {
//assert.NotNil(t, res)
//assert.True(t, proto.Equal(res.Msg, getRunnersResp))
//},
//},
//"error": {
//serverFn: func(t *testing.T, mockCtl *gomock.Controller) *server {
...
//)
//mockSvc := orgsservice.NewMockService(mockCtl)
//mockSvc.EXPECT().GetRunners(gomock.Any(), orgID).Return(nil, testErr)
...
//res, err := server.GetRunners(ctx, req)
