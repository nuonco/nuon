...
//
//		tests := map[string]struct {
//			fetcher     func(*testing.T) *mockFetcher
//			errExpected error
//		}{
//			"happy path": {
//				fetcher: func(t *testing.T) *mockFetcher {
//					m := &mockFetcher{}
//					m.
//						On("fetch", mock.Anything, mock.AnythingOfType("*s3.Client")).
//						Return(
//							io.NopCloser(strings.NewReader(t.Name())),
//							nil,
//						)
//					return m
//				},
...
//					m.
//						On("fetch", mock.Anything, mock.AnythingOfType("*s3.Client")).
//						Return(io.NopCloser(nil), fmt.Errorf("error downloading"))
//					return m
//				},
//				errExpected: fmt.Errorf("error downloading"),
//			},
//		}
//
//		for name, test := range tests {
...
//				s, err := NewS3(
//					v,
//					WithBucketKey(t.Name()),
//					WithBucketName(t.Name()),
//					WithRoleARN(t.Name()),
//					WithRoleSessionName(t.Name()),
//				)
//				assert.NoError(t, err)
//				s.fetcher = f
//
//				iorc, err := s.Fetch(ctx)
//				if test.errExpected != nil {
//					assert.ErrorContains(t, err, test.errExpected.Error())
//					return
//				}
