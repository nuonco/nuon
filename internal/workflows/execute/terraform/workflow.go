...
func (w *wkflow) ExecuteTerraformPlan(ctx workflow.Context, req *executev1.ExecutePlanRequest) (*executev1.ExecutePlanResponse, error) {
...
func execExecutePlanLocally(
	...
	fut := workflow.ExecuteActivity(ctx, act.ExecuteTerraformPlanLocally, req)
