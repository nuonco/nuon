module github.com/powertoolsdev/workers-executors
...
require (
	...
	github.com/powertoolsdev/go-fetch v0.0.0-20230206123347-ccd22388bd62
	...
	github.com/powertoolsdev/protos v0.60.2
